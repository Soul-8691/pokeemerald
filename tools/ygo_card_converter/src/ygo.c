...
const u16 CardIdMapping[] = 
{
    ...
    [ITEM_CARD_7_COLORED_FISH] = 1,
    [ITEM_CARD_A_LEGENDARY_OCEAN] = 1,
    [ITEM_CARD_ABC_DRAGON_BUSTER] = 1,
    [ITEM_CARD_ABYSS_DWELLER] = 1,
    [ITEM_CARD_ABYSS_SOLDIER] = 1,
    [ITEM_CARD_ABYSS_SPHERE] = 1,
    [ITEM_CARD_ADVANCED_RITUAL_ART] = 1,
    [ITEM_CARD_AGIDO_THE_ANCIENT_SENTINEL] = 1,
    [ITEM_CARD_AIRKNIGHT_PARSHATH] = 1,
    [ITEM_CARD_ALBA_LENATUS_THE_ABYSS_DRAGON] = 1,
    [ITEM_CARD_ALBAZ_THE_ASHEN] = 1,
    [ITEM_CARD_ALBION_THE_SANCTIFIRE_DRAGON] = 1,
    [ITEM_CARD_ALBION_THE_SHROUDED_DRAGON] = 1,
    [ITEM_CARD_ALEXANDRITE_DRAGON] = 1,
    [ITEM_CARD_ALLURE_OF_DARKNESS] = 1,
    [ITEM_CARD_ALLY_OF_JUSTICE_CATASTOR] = 1,
    [ITEM_CARD_ALLY_OF_JUSTICE_CYCLE_READER] = 1,
    [ITEM_CARD_ALUBER_THE_JESTER_OF_DESPIA] = 1,
    [ITEM_CARD_AMAZONESS_ARCHER] = 1,
    [ITEM_CARD_AMAZONESS_SPIRITUALIST] = 1,
    [ITEM_CARD_AMPHIBIOUS_BUGROTH_MK_3] = 1,
    [ITEM_CARD_AMULET_DRAGON] = 1,
    [ITEM_CARD_ANCIENT_FAIRY_DRAGON] = 1,
    [ITEM_CARD_ANCIENT_GEAR_DRAGON] = 1,
    [ITEM_CARD_ANCIENT_GEAR_GOLEM_ULTIMATE_POUND] = 1,
    [ITEM_CARD_ANGMARL_THE_FIENDISH_MONARCH] = 1,
    [ITEM_CARD_ANTI_SPELL_FRAGRANCE] = 1,
    [ITEM_CARD_APOLLOUSA_BOW_OF_THE_GODDESS] = 1,
    [ITEM_CARD_APPRENTICE_ILLUSION_MAGICIAN] = 1,
    [ITEM_CARD_AQUA_MADOOR] = 1,
    [ITEM_CARD_AQUA_SPIRIT] = 1,
    [ITEM_CARD_ARCANITE_MAGICIAN] = 1,
    [ITEM_CARD_ARCHFIEND_BLACK_SKULL_DRAGON] = 1,
    [ITEM_CARD_ARCHFIEND_CAVALRY] = 1,
    [ITEM_CARD_ARCHFIEND_COMMANDER] = 1,
    [ITEM_CARD_ARCHFIEND_ECCENTRICK] = 1,
    [ITEM_CARD_ARCHFIEND_EMPRESS] = 1,
    [ITEM_CARD_ARCHFIEND_GIANT] = 1,
    [ITEM_CARD_ARCHFIEND_HEIRESS] = 1,
    [ITEM_CARD_ARCHFIEND_INTERCEPTOR] = 1,
    [ITEM_CARD_ARCHFIEND_OF_GILFER] = 1,
    [ITEM_CARD_ARCHFIEND_SOLDIER] = 1,
    [ITEM_CARD_ARCHFIEND_S_ADVENT] = 1,
    [ITEM_CARD_ARCHFIEND_S_MANIFESTATION] = 1,
    [ITEM_CARD_ARCHNEMESES_PROTOS] = 1,
    [ITEM_CARD_ARIEL_PRIESTESS_OF_THE_NEKROZ] = 1,
    [ITEM_CARD_ARISEN_GAIA_THE_FIERCE_KNIGHT] = 1,
    [ITEM_CARD_ARMAGEDDON_KNIGHT] = 1,
    [ITEM_CARD_ARMED_NINJA] = 1,
    [ITEM_CARD_ARMORED_CYBERN] = 1,
    [ITEM_CARD_ARMORY_ARM] = 1,
    [ITEM_CARD_ARSENAL_BUG] = 1,
    [ITEM_CARD_ARSENAL_SUMMONER] = 1,
    [ITEM_CARD_ARTIFACT_LANCEA] = 1,
    [ITEM_CARD_ARTIFACT_MORALLTACH] = 1,
    [ITEM_CARD_ARTIFACT_SANCTUM] = 1,
    [ITEM_CARD_ASH_BLOSSOM_JOYOUS_SPRING] = 1,
    [ITEM_CARD_ASURA_PRIEST] = 1,
    [ITEM_CARD_ATLANTEAN_DRAGOONS] = 1,
    [ITEM_CARD_ATLANTEAN_HEAVY_INFANTRY] = 1,
    [ITEM_CARD_ATLANTEAN_MARKSMAN] = 1,
    [ITEM_CARD_AURKUS_LIGHTSWORN_DRUID] = 1,
    [ITEM_CARD_AVANCE_SWORDSMAN_OF_THE_NEKROZ] = 1,
    [ITEM_CARD_AXE_DRAGONUTE] = 1,
    [ITEM_CARD_AXE_OF_DESPAIR] = 1,
    [ITEM_CARD_BAKU_THE_BEAST_NINJA] = 1,
    [ITEM_CARD_BANISHER_OF_THE_LIGHT] = 1,
    [ITEM_CARD_BANISHER_OF_THE_RADIANCE] = 1,
    [ITEM_CARD_BAOBABOON] = 1,
    [ITEM_CARD_BARREL_BEHIND_THE_DOOR] = 1,
    [ITEM_CARD_BATTLE_FOOTBALLER] = 1,
    [ITEM_CARD_BATTLE_OX] = 1,
    [ITEM_CARD_BAXIA_BRIGHTNESS_OF_THE_YANG_ZING] = 1,
    [ITEM_CARD_BAZOO_THE_SOUL_EATER] = 1,
    [ITEM_CARD_BEAST_OF_TALWAR] = 1,
    [ITEM_CARD_BEAST_OF_TALWAR_THE_SWORD_SUMMIT] = 1,
    [ITEM_CARD_BEATRICE_LADY_OF_THE_ETERNAL] = 1,
    [ITEM_CARD_BECKONING_LIGHT] = 1,
    [ITEM_CARD_BEGINNING_KNIGHT] = 1,
    [ITEM_CARD_BEIIGE_VANGUARD_OF_DARK_WORLD] = 1,
    [ITEM_CARD_BERLINETH_THE_FIRESTORM_VASSAL] = 1,
    [ITEM_CARD_BERSERK_DRAGON] = 1,
    [ITEM_CARD_BERSERK_GORILLA] = 1,
    [ITEM_CARD_BICKURIBOX] = 1,
    [ITEM_CARD_BIG_BANG_SHOT] = 1,
    [ITEM_CARD_BIG_SHIELD_GARDNA] = 1,
    [ITEM_CARD_BIG_TUSKED_MAMMOTH] = 1,
    [ITEM_CARD_BLACK_DRAGON_S_CHICK] = 1,
    [ITEM_CARD_BLACK_HORN_OF_HEAVEN] = 1,
    [ITEM_CARD_BLACK_ILLUSION_RITUAL] = 1,
    [ITEM_CARD_BLACK_LUSTER_SOLDIER_ENVOY_OF_THE_BEGINNING] = 1,
    [ITEM_CARD_BLACK_LUSTER_SOLDIER_ENVOY_OF_THE_EVENING_TWILIGHT] = 1,
    [ITEM_CARD_BLACK_METAL_DRAGON] = 1,
    [ITEM_CARD_BLACK_PENDANT] = 1,
    [ITEM_CARD_BLACK_ROSE_DRAGON] = 1,
    [ITEM_CARD_BLACK_SKULL_DRAGON] = 1,
    [ITEM_CARD_BLACK_WHIRLWIND] = 1,
    [ITEM_CARD_BLACKWING_BLIZZARD_THE_FAR_NORTH] = 1,
    [ITEM_CARD_BLACKWING_BORA_THE_SPEAR] = 1,
    [ITEM_CARD_BLACKWING_GALE_THE_WHIRLWIND] = 1,
    [ITEM_CARD_BLACKWING_KALUT_THE_MOON_SHADOW] = 1,
    [ITEM_CARD_BLACKWING_SHURA_THE_BLUE_FLAME] = 1,
    [ITEM_CARD_BLACKWING_SILVERWIND_THE_ASCENDANT] = 1,
    [ITEM_CARD_BLACKWING_SIROCCO_THE_DAWN] = 1,
    [ITEM_CARD_BLACKWING_VAYU_THE_EMBLEM_OF_HONOR] = 1,
    [ITEM_CARD_BLACKWING_ARMED_WING] = 1,
    [ITEM_CARD_BLACKWING_ARMOR_MASTER] = 1,
    [ITEM_CARD_BLADE_KNIGHT] = 1,
    [ITEM_CARD_BLAST_WITH_CHAIN] = 1,
    [ITEM_CARD_BLASTER_DRAGON_RULER_OF_INFERNOS] = 1,
    [ITEM_CARD_BLAZING_CARTESIA_THE_VIRTUOUS] = 1,
    [ITEM_CARD_BLAZING_INPACHI] = 1,
    [ITEM_CARD_BLINDLY_LOYAL_GOBLIN] = 1,
    [ITEM_CARD_BLOCK_ATTACK] = 1,
    [ITEM_CARD_BLOWBACK_DRAGON] = 1,
    [ITEM_CARD_BLUE_FLAME_SWORDSMAN] = 1,
    [ITEM_CARD_BLUE_EYES_ALTERNATIVE_ULTIMATE_DRAGON] = 1,
    [ITEM_CARD_BLUE_EYES_ALTERNATIVE_WHITE_DRAGON] = 1,
    [ITEM_CARD_BLUE_EYES_JET_DRAGON] = 1,
    [ITEM_CARD_BLUE_EYES_TOON_DRAGON] = 1,
    [ITEM_CARD_BLUE_EYES_TWIN_BURST_DRAGON] = 1,
    [ITEM_CARD_BLUE_EYES_TYRANT_DRAGON] = 1,
    [ITEM_CARD_BLUE_EYES_ULTIMATE_DRAGON] = 1,
    [ITEM_CARD_BLUE_EYES_WHITE_DRAGON] = 1,
    [ITEM_CARD_BM_4_BLAST_SPIDER] = 1,
    [ITEM_CARD_BONE_ARCHFIEND] = 1,
    [ITEM_CARD_BONFIRE] = 1,
    [ITEM_CARD_BOOK_OF_ECLIPSE] = 1,
    [ITEM_CARD_BOOK_OF_LIFE] = 1,
    [ITEM_CARD_BOOK_OF_MOON] = 1,
    [ITEM_CARD_BOOK_OF_TAIYOU] = 1,
    [ITEM_CARD_BORRELOAD_DRAGON] = 1,
    [ITEM_CARD_BOTTOMLESS_TRAP_HOLE] = 1,
    [ITEM_CARD_BOWGANIAN] = 1,
    [ITEM_CARD_BRAIN_CONTROL] = 1,
    [ITEM_CARD_BRANDED_IN_HIGH_SPIRITS] = 1,
    [ITEM_CARD_BREAKER_THE_MAGICAL_WARRIOR] = 1,
    [ITEM_CARD_BREAKTHROUGH_SKILL] = 1,
    [ITEM_CARD_BRIGRAND_THE_GLORY_DRAGON] = 1,
    [ITEM_CARD_BRILLIANT_ROSE] = 1,
    [ITEM_CARD_BRIONAC_DRAGON_OF_THE_ICE_BARRIER] = 1,
    [ITEM_CARD_BROTHERHOOD_OF_THE_FIRE_FIST_BEAR] = 1,
    [ITEM_CARD_BROWW_HUNTSMAN_OF_DARK_WORLD] = 1,
    [ITEM_CARD_BRRON_MAD_KING_OF_DARK_WORLD] = 1,
    [ITEM_CARD_BURIAL_FROM_A_DIFFERENT_DIMENSION] = 1,
    [ITEM_CARD_BURNER_DRAGON_RULER_OF_SPARKS] = 1,
    [ITEM_CARD_BUSTER_BLADER] = 1,
    [ITEM_CARD_BUSTER_BLADER_THE_DESTRUCTION_SWORDMASTER] = 1,
    [ITEM_CARD_BUSTER_BLADER_THE_DRAGON_DESTROYER_SWORDSMAN] = 1,
    [ITEM_CARD_BYSER_SHOCK] = 1,
    [ITEM_CARD_BYSTIAL_BALDRAKE] = 1,
    [ITEM_CARD_BYSTIAL_DRUISWURM] = 1,
    [ITEM_CARD_BYSTIAL_MAGNAMHUT] = 1,
    [ITEM_CARD_BYSTIAL_SARONIR] = 1,
    [ITEM_CARD_CAIUS_THE_MEGA_MONARCH] = 1,
    [ITEM_CARD_CAIUS_THE_SHADOW_MONARCH] = 1,
    [ITEM_CARD_CALL_OF_THE_HAUNTED] = 1,
    [ITEM_CARD_CALLED_BY_THE_GRAVE] = 1,
    [ITEM_CARD_CANNON_SOLDIER] = 1,
    [ITEM_CARD_CARD_DESTRUCTION] = 1,
    [ITEM_CARD_CARD_OF_DEMISE] = 1,
    [ITEM_CARD_CARD_OF_SAFE_RETURN] = 1,
    [ITEM_CARD_CARD_TROOPER] = 1,
    [ITEM_CARD_CARDS_FROM_THE_SKY] = 1,
    [ITEM_CARD_CARDS_OF_CONSONANCE] = 1,
    [ITEM_CARD_CASTEL_THE_SKYBLASTER_MUSKETEER] = 1,
    [ITEM_CARD_CASTLE_OF_DARK_ILLUSIONS] = 1,
    [ITEM_CARD_CASTLE_WALLS] = 1,
    [ITEM_CARD_CATAPULT_TURTLE] = 1,
    [ITEM_CARD_CEASEFIRE] = 1,
    [ITEM_CARD_CELESTIA_LIGHTSWORN_ANGEL] = 1,
    [ITEM_CARD_CHAIN_DISAPPEARANCE] = 1,
    [ITEM_CARD_CHAIN_ENERGY] = 1,
    [ITEM_CARD_CHAINSAW_INSECT] = 1,
    [ITEM_CARD_CHANGE_OF_HEART] = 1,
    [ITEM_CARD_CHAOS_EMPEROR_DRAGON_ENVOY_OF_THE_END] = 1,
    [ITEM_CARD_CHAOS_HUNTER] = 1,
    [ITEM_CARD_CHAOS_NEPHTHYS] = 1,
    [ITEM_CARD_CHAOS_SORCERER] = 1,
    [ITEM_CARD_CHARCOAL_INPACHI] = 1,
    [ITEM_CARD_CHARGE_OF_THE_LIGHT_BRIGADE] = 1,
    [ITEM_CARD_CHARGING_GAIA_THE_FIERCE_KNIGHT] = 1,
    [ITEM_CARD_CHICKEN_GAME] = 1,
    [ITEM_CARD_CHIMERATECH_FORTRESS_DRAGON] = 1,
    [ITEM_CARD_CHIMERATECH_OVERDRAGON] = 1,
    [ITEM_CARD_CHIRON_THE_MAGE] = 1,
    [ITEM_CARD_CHRONICLE_MAGICIAN] = 1,
    [ITEM_CARD_CHRONICLE_SORCERESS] = 1,
    [ITEM_CARD_CIPHER_SOLDIER] = 1,
    [ITEM_CARD_CIR_MALEBRANCHE_OF_THE_BURNING_ABYSS] = 1,
    [ITEM_CARD_CLORLESS_CHAOS_KING_OF_DARK_WORLD] = 1,
    [ITEM_CARD_COLD_WAVE] = 1,
    [ITEM_CARD_COLOSSAL_FIGHTER] = 1,
    [ITEM_CARD_COMMAND_KNIGHT] = 1,
    [ITEM_CARD_COMPULSORY_EVACUATION_DEVICE] = 1,
    [ITEM_CARD_CONFISCATION] = 1,
    [ITEM_CARD_CONSECRATED_LIGHT] = 1,
    [ITEM_CARD_COSMIC_CYCLONE] = 1,
    [ITEM_CARD_CRASS_CLOWN] = 1,
    [ITEM_CARD_CREATURE_SWAP] = 1,
    [ITEM_CARD_CREVICE_INTO_THE_DIFFERENT_DIMENSION] = 1,
    [ITEM_CARD_CRIMSON_BLADER] = 1,
    [ITEM_CARD_CRIMSON_NINJA] = 1,
    [ITEM_CARD_CROSSOUT_DESIGNATOR] = 1,
    [ITEM_CARD_CRUSH_CARD_VIRUS] = 1,
    [ITEM_CARD_CRYSTAL_ROSE] = 1,
    [ITEM_CARD_CURSED_SEAL_OF_THE_FORBIDDEN_SPELL] = 1,
    [ITEM_CARD_CYBER_DRAGON] = 1,
    [ITEM_CARD_CYBER_DRAGON_DREI] = 1,
    [ITEM_CARD_CYBER_DRAGON_INFINITY] = 1,
    [ITEM_CARD_CYBER_DRAGON_NOVA] = 1,
    [ITEM_CARD_CYBER_DRAGON_VIER] = 1,
    [ITEM_CARD_CYBER_DRAGON_ZWEI] = 1,
    [ITEM_CARD_CYBER_ELTANIN] = 1,
    [ITEM_CARD_CYBER_END_DRAGON] = 1,
    [ITEM_CARD_CYBER_HARPIE_LADY] = 1,
    [ITEM_CARD_CYBER_JAR] = 1,
    [ITEM_CARD_CYBER_LARVA] = 1,
    [ITEM_CARD_CYBER_PHOENIX] = 1,
    [ITEM_CARD_CYBER_TWIN_DRAGON] = 1,
    [ITEM_CARD_CYBER_VALLEY] = 1,
    [ITEM_CARD_CYBER_STEIN] = 1,
    [ITEM_CARD_CYBERDARK_WURM] = 1,
    [ITEM_CARD_CYNET_MINING] = 1,
    [ITEM_CARD_D_D_ASSAILANT] = 1,
    [ITEM_CARD_D_D_CRAZY_BEAST] = 1,
    [ITEM_CARD_D_D_CROW] = 1,
    [ITEM_CARD_D_D_SURVIVOR] = 1,
    [ITEM_CARD_D_D_TRAINER] = 1,
    [ITEM_CARD_D_D_WARRIOR_LADY] = 1,
    [ITEM_CARD_DAIGUSTO_EMERAL] = 1,
    [ITEM_CARD_DANCE_PRINCESS_OF_THE_NEKROZ] = 1,
    [ITEM_CARD_DANDYLION] = 1,
    [ITEM_CARD_DANGER_NESSIE_] = 1,
    [ITEM_CARD_DANTE_TRAVELER_OF_THE_BURNING_ABYSS] = 1,
    [ITEM_CARD_DARK_ARMED_DRAGON] = 1,
    [ITEM_CARD_DARK_BALTER_THE_TERRIBLE] = 1,
    [ITEM_CARD_DARK_BLADE] = 1,
    [ITEM_CARD_DARK_BLADE_THE_DRAGON_KNIGHT] = 1,
    [ITEM_CARD_DARK_CAVALRY] = 1,
    [ITEM_CARD_DARK_DEAL] = 1,
    [ITEM_CARD_DARK_ELF] = 1,
    [ITEM_CARD_DARK_END_DRAGON] = 1,
    [ITEM_CARD_DARK_ERADICATOR_WARLOCK] = 1,
    [ITEM_CARD_DARK_FLARE_KNIGHT] = 1,
    [ITEM_CARD_DARK_GREPHER] = 1,
    [ITEM_CARD_DARK_HOLE] = 1,
    [ITEM_CARD_DARK_MAGIC_CURTAIN] = 1,
    [ITEM_CARD_DARK_MAGICIAN] = 1,
    [ITEM_CARD_DARK_MAGICIAN_GIRL] = 1,
    [ITEM_CARD_DARK_MAGICIAN_GIRL_THE_DRAGON_KNIGHT] = 1,
    [ITEM_CARD_DARK_MAGICIAN_GIRL_THE_MAGICIAN_S_APPRENTICE] = 1,
    [ITEM_CARD_DARK_MAGICIAN_OF_CHAOS] = 1,
    [ITEM_CARD_DARK_MAGICIAN_THE_DRAGON_KNIGHT] = 1,
    [ITEM_CARD_DARK_MAGICIAN_THE_KNIGHT_OF_DRAGON_MAGIC] = 1,
    [ITEM_CARD_DARK_MIMIC_LV1] = 1,
    [ITEM_CARD_DARK_MIMIC_LV3] = 1,
    [ITEM_CARD_DARK_NEPHTHYS] = 1,
    [ITEM_CARD_DARK_PALADIN] = 1,
    [ITEM_CARD_DARK_RULER_HA_DES] = 1,
    [ITEM_CARD_DARK_RULER_NO_MORE] = 1,
    [ITEM_CARD_DARK_SCORPION_CHICK_THE_YELLOW] = 1,
    [ITEM_CARD_DARK_SCORPION_CLIFF_THE_TRAP_REMOVER] = 1,
    [ITEM_CARD_DARK_STRIKE_FIGHTER] = 1,
    [ITEM_CARD_DARK_WORLD_LIGHTNING] = 1,
    [ITEM_CARD_DARKFIRE_DRAGON] = 1,
    [ITEM_CARD_DARKLORD_ZERATO] = 1,
    [ITEM_CARD_DE_FUSION] = 1,
    [ITEM_CARD_DE_SPELL] = 1,
    [ITEM_CARD_DEBRIS_DRAGON] = 1,
    [ITEM_CARD_DEBUNK] = 1,
    [ITEM_CARD_DECK_DEVASTATION_VIRUS] = 1,
    [ITEM_CARD_DEEP_SEA_DIVA] = 1,
    [ITEM_CARD_DEEP_EYES_WHITE_DRAGON] = 1,
    [ITEM_CARD_DEFENDER_OF_NEPHTHYS] = 1,
    [ITEM_CARD_DEKOICHI_THE_BATTLECHANTED_LOCOMOTIVE] = 1,
    [ITEM_CARD_DELG_THE_DARK_MONARCH] = 1,
    [ITEM_CARD_DELINQUENT_DUO] = 1,
    [ITEM_CARD_DEMISE_KING_OF_ARMAGEDDON] = 1,
    [ITEM_CARD_DENKO_SEKKA] = 1,
    [ITEM_CARD_DES_DENDLE] = 1,
    [ITEM_CARD_DES_KOALA] = 1,
    [ITEM_CARD_DES_LACOODA] = 1,
    [ITEM_CARD_DES_WOMBAT] = 1,
    [ITEM_CARD_DESERT_SUNLIGHT] = 1,
    [ITEM_CARD_DESTINY_DRAW] = 1,
    [ITEM_CARD_DESTINY_HERO_CELESTIAL] = 1,
    [ITEM_CARD_DESTINY_HERO_DASHER] = 1,
    [ITEM_CARD_DESTINY_HERO_DESTROYER_PHOENIX_ENFORCER] = 1,
    [ITEM_CARD_DESTINY_HERO_DIAMOND_DUDE] = 1,
    [ITEM_CARD_DESTINY_HERO_DISK_COMMANDER] = 1,
    [ITEM_CARD_DESTINY_HERO_FEAR_MONGER] = 1,
    [ITEM_CARD_DESTINY_HERO_MALICIOUS] = 1,
    [ITEM_CARD_DHARC_THE_DARK_CHARMER_GLOOMY] = 1,
    [ITEM_CARD_DIABELLSTAR_THE_BLACK_WITCH] = 1,
    [ITEM_CARD_DIAMOND_DIRE_WOLF] = 1,
    [ITEM_CARD_DIAN_KETO_THE_CURE_MASTER] = 1,
    [ITEM_CARD_DICTATOR_OF_D_] = 1,
    [ITEM_CARD_DIMENSION_CONJURER] = 1,
    [ITEM_CARD_DIMENSION_FUSION] = 1,
    [ITEM_CARD_DIMENSION_SHIFTER] = 1,
    [ITEM_CARD_DIMENSION_WALL] = 1,
    [ITEM_CARD_DIMENSIONAL_BARRIER] = 1,
    [ITEM_CARD_DIMENSIONAL_FISSURE] = 1,
    [ITEM_CARD_DIMENSIONAL_PRISON] = 1,
    [ITEM_CARD_DINGIRSU_THE_ORCUST_OF_THE_EVENING_STAR] = 1,
    [ITEM_CARD_DINOMIGHT_KNIGHT_THE_TRUE_DRACOFIGHTER] = 1,
    [ITEM_CARD_DINOSTER_POWER_THE_MIGHTY_DRACOSLAYER] = 1,
    [ITEM_CARD_DINOWRESTLER_CAPAPTERA] = 1,
    [ITEM_CARD_DINOWRESTLER_PANKRATOPS] = 1,
    [ITEM_CARD_DINOWRESTLER_VALEONYX] = 1,
    [ITEM_CARD_DISCIPLE_OF_NEPHTHYS] = 1,
    [ITEM_CARD_DIVINE_ARSENAL_AA_ZEUS_SKY_THUNDER] = 1,
    [ITEM_CARD_DIVINE_DRAGON_KNIGHT_FELGRAND] = 1,
    [ITEM_CARD_DIVINE_TEMPLE_OF_THE_SNAKE_EYE] = 1,
    [ITEM_CARD_DIVINE_WRATH] = 1,
    [ITEM_CARD_DNA_SURGERY] = 1,
    [ITEM_CARD_DOMINUS_IMPULSE] = 1,
    [ITEM_CARD_DON_ZALOOG] = 1,
    [ITEM_CARD_DOOM_DOZER] = 1,
    [ITEM_CARD_DOOMCALIBER_KNIGHT] = 1,
    [ITEM_CARD_DOOMKAISER_DRAGON] = 1,
    [ITEM_CARD_DOWNERD_MAGICIAN] = 1,
    [ITEM_CARD_DRACO_FACE_OFF] = 1,
    [ITEM_CARD_DRACOBACK_THE_RIDEABLE_DRAGON] = 1,
    [ITEM_CARD_DRAGGED_DOWN_INTO_THE_GRAVE] = 1,
    [ITEM_CARD_DRAGON_RAVINE] = 1,
    [ITEM_CARD_DRAGON_SHRINE] = 1,
    [ITEM_CARD_DRAGON_S_MIRROR] = 1,
    [ITEM_CARD_DRAGON_S_RAGE] = 1,
    [ITEM_CARD_DRAGONESS_THE_WICKED_KNIGHT] = 1,
    [ITEM_CARD_DRAGONIC_DIAGRAM] = 1,
    [ITEM_CARD_DRAGUNITY_CORSESCA] = 1,
    [ITEM_CARD_DREAM_CLOWN] = 1,
    [ITEM_CARD_DRILLROID] = 1,
    [ITEM_CARD_DROLL_LOCK_BIRD] = 1,
    [ITEM_CARD_DROP_OFF] = 1,
    [ITEM_CARD_DUNAMES_DARK_WITCH] = 1,
    [ITEM_CARD_DUPE_FROG] = 1,
    [ITEM_CARD_DUST_TORNADO] = 1,
    [ITEM_CARD_EARTH_EFFIGY] = 1,
    [ITEM_CARD_EARTHBOUND_SPIRIT] = 1,
    [ITEM_CARD_EFFECT_VEILER] = 1,
    [ITEM_CARD_EHTHER_THE_HEAVENLY_MONARCH] = 1,
    [ITEM_CARD_EIDOS_THE_UNDERWORLD_MONARCH] = 1,
    [ITEM_CARD_EIDOS_THE_UNDERWORLD_SQUIRE] = 1,
    [ITEM_CARD_EL_SHADDOLL_ANOYATYLLIS] = 1,
    [ITEM_CARD_EL_SHADDOLL_APKALLONE] = 1,
    [ITEM_CARD_EL_SHADDOLL_CONSTRUCT] = 1,
    [ITEM_CARD_EL_SHADDOLL_FUSION] = 1,
    [ITEM_CARD_EL_SHADDOLL_GRYSTA] = 1,
    [ITEM_CARD_EL_SHADDOLL_SHEKHINAGA] = 1,
    [ITEM_CARD_EL_SHADDOLL_WENDIGO] = 1,
    [ITEM_CARD_EL_SHADDOLL_WINDA] = 1,
    [ITEM_CARD_ELDER_ENTITY_NORDEN] = 1,
    [ITEM_CARD_ELECTRIC_SNAKE] = 1,
    [ITEM_CARD_ELECTRIC_VIRUS] = 1,
    [ITEM_CARD_ELEMENTAL_HERO_BLAZEMAN] = 1,
    [ITEM_CARD_ELEMENTAL_HERO_CLAYMAN] = 1,
    [ITEM_CARD_ELEMENTAL_HERO_FLAME_WINGMAN] = 1,
    [ITEM_CARD_ELEMENTAL_HERO_PRISMA] = 1,
    [ITEM_CARD_ELEMENTAL_HERO_STRATOS] = 1,
    [ITEM_CARD_ELEMENTAL_HERO_WILDHEART] = 1,
    [ITEM_CARD_ELEMENTAL_HERO_WOODSMAN] = 1,
    [ITEM_CARD_EMERGENCY_PROVISIONS] = 1,
    [ITEM_CARD_EMERGENCY_TELEPORT] = 1,
    [ITEM_CARD_EMILIA_DANCE_PRIESTESS_OF_THE_NEKROZ] = 1,
    [ITEM_CARD_EMISSARY_OF_THE_AFTERLIFE] = 1,
    [ITEM_CARD_EMPRESS_JUDGE] = 1,
    [ITEM_CARD_ENEMY_CONTROLLER] = 1,
    [ITEM_CARD_ENVOY_OF_CHAOS] = 1,
    [ITEM_CARD_ERADICATOR_EPIDEMIC_VIRUS] = 1,
    [ITEM_CARD_EREBUS_THE_UNDERWORLD_MONARCH] = 1,
    [ITEM_CARD_ESCAPE_FROM_THE_DARK_DIMENSION] = 1,
    [ITEM_CARD_EVENING_TWILIGHT_KNIGHT] = 1,
    [ITEM_CARD_EVENLY_MATCHED] = 1,
    [ITEM_CARD_EVILSWARM_EXCITON_KNIGHT] = 1,
    [ITEM_CARD_EVILSWARM_HELIOTROPE] = 1,
    [ITEM_CARD_EVILSWARM_KETOS] = 1,
    [ITEM_CARD_EVOLZAR_LAGGIA] = 1,
    [ITEM_CARD_EXA_ENFORCER_OF_THE_NEKROZ] = 1,
    [ITEM_CARD_EXARION_UNIVERSE] = 1,
    [ITEM_CARD_EXCHANGE] = 1,
    [ITEM_CARD_EXCHANGE_OF_THE_SPIRIT] = 1,
    [ITEM_CARD_EXILED_FORCE] = 1,
    [ITEM_CARD_EXODIA_THE_FORBIDDEN_ONE] = 1,
    [ITEM_CARD_EXT_RYZEAL] = 1,
    [ITEM_CARD_FABLED_LURRIE] = 1,
    [ITEM_CARD_FAIRY_TAIL_SNOW] = 1,
    [ITEM_CARD_FAIRY_WIND] = 1,
    [ITEM_CARD_FAKE_TRAP] = 1,
    [ITEM_CARD_FALLEN_OF_ALBAZ] = 1,
    [ITEM_CARD_FAMILIAR_POSSESSED_AUSSA] = 1,
    [ITEM_CARD_FAMILIAR_POSSESSED_ERIA] = 1,
    [ITEM_CARD_FAMILIAR_POSSESSED_HIITA] = 1,
    [ITEM_CARD_FAMILIAR_POSSESSED_WYNN] = 1,
    [ITEM_CARD_FANTASTICAL_DRAGON_PHANTAZMAY] = 1,
    [ITEM_CARD_FARFA_MALEBRANCHE_OF_THE_BURNING_ABYSS] = 1,
    [ITEM_CARD_FATEFUL_ADVENTURE] = 1,
    [ITEM_CARD_FIBER_JAR] = 1,
    [ITEM_CARD_FIEND_GRIEFING] = 1,
    [ITEM_CARD_FIEND_SKULL_DRAGON] = 1,
    [ITEM_CARD_FIENDISH_CHAIN] = 1,
    [ITEM_CARD_FIENDSMITH_ENGRAVER] = 1,
    [ITEM_CARD_FIENDSMITH_S_LACRIMA] = 1,
    [ITEM_CARD_FIENDSMITH_S_REQUIEM] = 1,
    [ITEM_CARD_FIENDSMITH_S_SEQUENCE] = 1,
    [ITEM_CARD_FIENDSMITH_S_TRACT] = 1,
    [ITEM_CARD_FIGHTING_FLAME_SWORDSMAN] = 1,
    [ITEM_CARD_FINAL_FLAME] = 1,
    [ITEM_CARD_FIRE_FORMATION_TENKI] = 1,
    [ITEM_CARD_FIRE_HAND] = 1,
    [ITEM_CARD_FIRE_KING_HIGH_AVATAR_KIRIN] = 1,
    [ITEM_CARD_FIRE_LAKE_OF_THE_BURNING_ABYSS] = 1,
    [ITEM_CARD_FIREWALL_DRAGON] = 1,
    [ITEM_CARD_FISSURE] = 1,
    [ITEM_CARD_FLAME_BUFFERLO] = 1,
    [ITEM_CARD_FLAME_GHOST] = 1,
    [ITEM_CARD_FLAME_SWORDSMAN] = 1,
    [ITEM_CARD_FLAMVELL_GUARD] = 1,
    [ITEM_CARD_FLIP_FLOP_FROG] = 1,
    [ITEM_CARD_FLOODGATE_TRAP_HOLE] = 1,
    [ITEM_CARD_FLYING_C_] = 1,
    [ITEM_CARD_FLYING_KAMAKIRI_1] = 1,
    [ITEM_CARD_FOOLISH_BURIAL] = 1,
    [ITEM_CARD_FORBIDDEN_APOCRYPHA] = 1,
    [ITEM_CARD_FORBIDDEN_CHALICE] = 1,
    [ITEM_CARD_FORBIDDEN_DROPLET] = 1,
    [ITEM_CARD_FORBIDDEN_LANCE] = 1,
    [ITEM_CARD_FORMULA_SYNCHRON] = 1,
    [ITEM_CARD_FOSSIL_DYNA_PACHYCEPHALO] = 1,
    [ITEM_CARD_FRONTIER_WISEMAN] = 1,
    [ITEM_CARD_FULL_HOUSE] = 1,
    [ITEM_CARD_FUSILIER_DRAGON_THE_DUAL_MODE_BEAST] = 1,
    [ITEM_CARD_FUSION_DESTINY] = 1,
    [ITEM_CARD_FUSION_DEVOURER] = 1,
    [ITEM_CARD_FUSION_SUBSTITUTE] = 1,
    [ITEM_CARD_GAGAGA_COWBOY] = 1,
    [ITEM_CARD_GAGAGIGO] = 1,
    [ITEM_CARD_GAIA_KNIGHT_THE_FORCE_OF_EARTH] = 1,
    [ITEM_CARD_GAIA_POWER] = 1,
    [ITEM_CARD_GAIA_THE_DRAGON_CHAMPION] = 1,
    [ITEM_CARD_GAIA_THE_FIERCE_KNIGHT] = 1,
    [ITEM_CARD_GALATEA_THE_ORCUST_AUTOMATON] = 1,
    [ITEM_CARD_GALAXY_CYCLONE] = 1,
    [ITEM_CARD_GAMECIEL_THE_SEA_TURTLE_KAIJU] = 1,
    [ITEM_CARD_GAROTH_LIGHTSWORN_WARRIOR] = 1,
    [ITEM_CARD_GARURA_WINGS_OF_RESONANT_LIFE] = 1,
    [ITEM_CARD_GATLING_DRAGON] = 1,
    [ITEM_CARD_GEAR_GOLEM_THE_MOVING_FORTRESS] = 1,
    [ITEM_CARD_GEARFRIED_THE_IRON_KNIGHT] = 1,
    [ITEM_CARD_GEARFRIED_THE_RED_EYES_IRON_KNIGHT] = 1,
    [ITEM_CARD_GEM_ARMADILLO] = 1,
    [ITEM_CARD_GEM_ELEPHANT] = 1,
    [ITEM_CARD_GEM_KNIGHT_ALEXANDRITE] = 1,
    [ITEM_CARD_GEM_KNIGHT_EMERALD] = 1,
    [ITEM_CARD_GEM_KNIGHT_GARNET] = 1,
    [ITEM_CARD_GEM_KNIGHT_HOLLOWCORE] = 1,
    [ITEM_CARD_GEM_KNIGHT_LADY_ROSE_DIAMOND] = 1,
    [ITEM_CARD_GEM_KNIGHT_NEPYRIM] = 1,
    [ITEM_CARD_GEM_KNIGHT_PRISMAURA] = 1,
    [ITEM_CARD_GEM_KNIGHT_QUARTZ] = 1,
    [ITEM_CARD_GEM_KNIGHT_RUBY] = 1,
    [ITEM_CARD_GEM_KNIGHT_SAPPHIRE] = 1,
    [ITEM_CARD_GEM_KNIGHT_TOURMALINE] = 1,
    [ITEM_CARD_GEM_KNIGHT_ZIRCONIA] = 1,
    [ITEM_CARD_GEM_TURTLE] = 1,
    [ITEM_CARD_GEMINI_ELF] = 1,
    [ITEM_CARD_GEMINI_IMPS] = 1,
    [ITEM_CARD_GENE_WARPED_WARWOLF] = 1,
    [ITEM_CARD_GENTA_GATEMAN_OF_DARK_WORLD] = 1,
    [ITEM_CARD_GHOST_BELLE_HAUNTED_MANSION] = 1,
    [ITEM_CARD_GHOST_MOURNER_MOONLIT_CHILL] = 1,
    [ITEM_CARD_GHOST_OGRE_SNOW_RABBIT] = 1,
    [ITEM_CARD_GHOST_REAPER_WINTER_CHERRIES] = 1,
    [ITEM_CARD_GHOST_SISTER_SPOOKY_DOGWOOD] = 1,
    [ITEM_CARD_GIANT_GERM] = 1,
    [ITEM_CARD_GIANT_ORC] = 1,
    [ITEM_CARD_GIANT_RAT] = 1,
    [ITEM_CARD_GIANT_RED_SEASNAKE] = 1,
    [ITEM_CARD_GIANT_SOLDIER_OF_STONE] = 1,
    [ITEM_CARD_GIANT_TRUNADE] = 1,
    [ITEM_CARD_GIGA_TECH_WOLF] = 1,
    [ITEM_CARD_GIGANTES] = 1,
    [ITEM_CARD_GIGANTIC_SPRIGHT] = 1,
    [ITEM_CARD_GIL_GARTH] = 1,
    [ITEM_CARD_GILASAURUS] = 1,
    [ITEM_CARD_GILTIA_THE_D_KNIGHT_SOUL_SPEAR] = 1,
    [ITEM_CARD_GISHKI_ABYSS] = 1,
    [ITEM_CARD_GISHKI_ARIEL] = 1,
    [ITEM_CARD_GISHKI_AVANCE] = 1,
    [ITEM_CARD_GISHKI_BEAST] = 1,
    [ITEM_CARD_GISHKI_CHAIN] = 1,
    [ITEM_CARD_GISHKI_EMILIA] = 1,
    [ITEM_CARD_GISHKI_GRIMNESS] = 1,
    [ITEM_CARD_GISHKI_MARKER] = 1,
    [ITEM_CARD_GISHKI_NATALIA] = 1,
    [ITEM_CARD_GISHKI_NOELLIA] = 1,
    [ITEM_CARD_GISHKI_SHADOW] = 1,
    [ITEM_CARD_GISHKI_VANITY] = 1,
    [ITEM_CARD_GISHKI_VISION] = 1,
    [ITEM_CARD_GLADIATOR_BEAST_BESTIARI] = 1,
    [ITEM_CARD_GLADIATOR_BEAST_DARIUS] = 1,
    [ITEM_CARD_GLADIATOR_BEAST_GAIODIAZ] = 1,
    [ITEM_CARD_GLADIATOR_BEAST_GYZARUS] = 1,
    [ITEM_CARD_GLADIATOR_BEAST_HERAKLINOS] = 1,
    [ITEM_CARD_GLADIATOR_BEAST_LAQUARI] = 1,
    [ITEM_CARD_GLADIATOR_BEAST_MURMILLO] = 1,
    [ITEM_CARD_GOBLIN_ATTACK_FORCE] = 1,
    [ITEM_CARD_GOBLIN_ELITE_ATTACK_FORCE] = 1,
    [ITEM_CARD_GOBLIN_POTHOLE_SQUAD] = 1,
    [ITEM_CARD_GOBLIN_ZOMBIE] = 1,
    [ITEM_CARD_GOKIPON] = 1,
    [ITEM_CARD_GOLD_SARCOPHAGUS] = 1,
    [ITEM_CARD_GOLDD_WU_LORD_OF_DARK_WORLD] = 1,
    [ITEM_CARD_GOLEM_SENTRY] = 1,
    [ITEM_CARD_GORA_TURTLE] = 1,
    [ITEM_CARD_GORZ_THE_EMISSARY_OF_DARKNESS] = 1,
    [ITEM_CARD_GOTTOMS_EMERGENCY_CALL] = 1,
    [ITEM_CARD_GOYO_GUARDIAN] = 1,
    [ITEM_CARD_GRACEFUL_CHARITY] = 1,
    [ITEM_CARD_GRAFF_MALEBRANCHE_OF_THE_BURNING_ABYSS] = 1,
    [ITEM_CARD_GRANGUIGNOL_THE_DUSK_DRAGON] = 1,
    [ITEM_CARD_GRANMARG_THE_MEGA_MONARCH] = 1,
    [ITEM_CARD_GRANMARG_THE_ROCK_MONARCH] = 1,
    [ITEM_CARD_GRAPHA_DRAGON_LORD_OF_DARK_WORLD] = 1,
    [ITEM_CARD_GRAPHA_DRAGON_OVERLORD_OF_DARK_WORLD] = 1,
    [ITEM_CARD_GRAVEKEEPER_S_ASSAILANT] = 1,
    [ITEM_CARD_GRAVEKEEPER_S_GUARD] = 1,
    [ITEM_CARD_GRAVEKEEPER_S_SPEAR_SOLDIER] = 1,
    [ITEM_CARD_GRAVEKEEPER_S_SPY] = 1,
    [ITEM_CARD_GRAVEKEEPER_S_WATCHER] = 1,
    [ITEM_CARD_GRAVITY_BIND] = 1,
    [ITEM_CARD_GREAT_WHITE] = 1,
    [ITEM_CARD_GREEN_NINJA] = 1,
    [ITEM_CARD_GREN_TACTICIAN_OF_DARK_WORLD] = 1,
    [ITEM_CARD_GUARDIAN_SPHINX] = 1,
    [ITEM_CARD_GUARDRAGON_GARMIDES] = 1,
    [ITEM_CARD_GUIDING_ARIADNE] = 1,
    [ITEM_CARD_GUNKAN_SUSHIP_SHARI] = 1,
    [ITEM_CARD_GYAKU_GIRE_PANDA] = 1,
    [ITEM_CARD_GYAKUTENNO_MEGAMI] = 1,
    [ITEM_CARD_HALLOWED_LIFE_BARRIER] = 1,
    [ITEM_CARD_HAMMER_SHOT] = 1,
    [ITEM_CARD_HAND_OF_NEPHTHYS] = 1,
    [ITEM_CARD_HANE_HANE] = 1,
    [ITEM_CARD_HANEWATA] = 1,
    [ITEM_CARD_HARPIE_S_FEATHER_DUSTER] = 1,
    [ITEM_CARD_HEART_OF_THE_BLUE_EYES] = 1,
    [ITEM_CARD_HEAVY_STORM] = 1,
    [ITEM_CARD_HEAVY_STORM_DUSTER] = 1,
    [ITEM_CARD_HERALD_OF_ORANGE_LIGHT] = 1,
    [ITEM_CARD_HERALD_OF_THE_ARC_LIGHT] = 1,
    [ITEM_CARD_HIERACOSPHINX] = 1,
    [ITEM_CARD_HIITA_THE_FIRE_CHARMER_ABLAZE] = 1,
    [ITEM_CARD_HONEST] = 1,
    [ITEM_CARD_HORN_OF_HEAVEN] = 1,
    [ITEM_CARD_HORN_OF_THE_PHANTOM_BEAST] = 1,
    [ITEM_CARD_HOWLING_INSECT] = 1,
    [ITEM_CARD_HUMANOID_SLIME] = 1,
    [ITEM_CARD_HYDROGEDDON] = 1,
    [ITEM_CARD_HYPER_HAMMERHEAD] = 1,
    [ITEM_CARD_I_P_MASQUERENA] = 1,
    [ITEM_CARD_ICARUS_ATTACK] = 1,
    [ITEM_CARD_ICE_HAND] = 1,
    [ITEM_CARD_ICE_KNIGHT] = 1,
    [ITEM_CARD_ICE_RYZEAL] = 1,
    [ITEM_CARD_IGNISTER_PROMINENCE_THE_BLASTING_DRACOSLAYER] = 1,
    [ITEM_CARD_ILLUSION_OF_CHAOS] = 1,
    [ITEM_CARD_ILLUSORY_SNATCHER] = 1,
    [ITEM_CARD_IMPERIAL_IRON_WALL] = 1,
    [ITEM_CARD_IMPERIAL_ORDER] = 1,
    [ITEM_CARD_INABA_WHITE_RABBIT] = 1,
    [ITEM_CARD_INCREDIBLE_ECCLESIA_THE_VIRTUOUS] = 1,
    [ITEM_CARD_INDOMITABLE_FIGHTER_LEI_LEI] = 1,
    [ITEM_CARD_INFERNALQUEEN_SALMON] = 1,
    [ITEM_CARD_INFERNITY_ARCHFIEND] = 1,
    [ITEM_CARD_INFERNITY_BARRIER] = 1,
    [ITEM_CARD_INFERNITY_BEETLE] = 1,
    [ITEM_CARD_INFERNITY_INFERNO] = 1,
    [ITEM_CARD_INFERNITY_LAUNCHER] = 1,
    [ITEM_CARD_INFERNITY_NECROMANCER] = 1,
    [ITEM_CARD_INFERNOID_DECATRON] = 1,
    [ITEM_CARD_INFERNOID_HARMADIK] = 1,
    [ITEM_CARD_INFERNOID_PATRULEA] = 1,
    [ITEM_CARD_INFINITE_IMPERMANENCE] = 1,
    [ITEM_CARD_INJECTION_FAIRY_LILY] = 1,
    [ITEM_CARD_INPACHI] = 1,
    [ITEM_CARD_INSECT_KNIGHT] = 1,
    [ITEM_CARD_INSTANT_FUSION] = 1,
    [ITEM_CARD_INTERRUPTED_KAIJU_SLUMBER] = 1,
    [ITEM_CARD_ISLAND_TURTLE] = 1,
    [ITEM_CARD_ISOLDE_TWO_TALES_OF_THE_NOBLE_KNIGHTS] = 1,
    [ITEM_CARD_JAR_OF_GREED] = 1,
    [ITEM_CARD_JINZO] = 1,
    [ITEM_CARD_JIOH_THE_GRAVITY_NINJA] = 1,
    [ITEM_CARD_JIRAI_GUMO] = 1,
    [ITEM_CARD_JONGLEUR_GHOUL_ILLUSIONIST] = 1,
    [ITEM_CARD_JOWGEN_THE_SPIRITUALIST] = 1,
    [ITEM_CARD_JUDGE_MAN] = 1,
    [ITEM_CARD_JUDGMENT_DRAGON] = 1,
    [ITEM_CARD_JURRAC_GUAIBA] = 1,
    [ITEM_CARD_JUST_DESSERTS] = 1,
    [ITEM_CARD_KABAZAULS] = 1,
    [ITEM_CARD_KAGEMUSHA_OF_THE_SIX_SAMURAI] = 1,
    [ITEM_CARD_KAGERO_THE_CANNON_NINJA] = 1,
    [ITEM_CARD_KAIBAMAN] = 1,
    [ITEM_CARD_KAISER_SEA_HORSE] = 1,
    [ITEM_CARD_KARMA_CUT] = 1,
    [ITEM_CARD_KASHTIRA_BIRTH] = 1,
    [ITEM_CARD_KASHTIRA_FENRIR] = 1,
    [ITEM_CARD_KASHTIRA_RISEHEART] = 1,
    [ITEM_CARD_KASHTIRA_UNICORN] = 1,
    [ITEM_CARD_KASHTIRATHEOSIS] = 1,
    [ITEM_CARD_KEEPER_OF_DRAGON_MAGIC] = 1,
    [ITEM_CARD_KEEPER_OF_THE_SHRINE] = 1,
    [ITEM_CARD_KELBEK_THE_ANCIENT_VANGUARD] = 1,
    [ITEM_CARD_KELDO_THE_SACRED_PROTECTOR] = 1,
    [ITEM_CARD_KING_DRAGUN] = 1,
    [ITEM_CARD_KING_OF_THE_FERAL_IMPS] = 1,
    [ITEM_CARD_KING_OF_THE_SWAMP] = 1,
    [ITEM_CARD_KING_TIGER_WANGHU] = 1,
    [ITEM_CARD_KNIGHTMARE_CERBERUS] = 1,
    [ITEM_CARD_KNIGHTMARE_GOBLIN] = 1,
    [ITEM_CARD_KNIGHTMARE_PHOENIX] = 1,
    [ITEM_CARD_KNIGHTMARE_UNICORN] = 1,
    [ITEM_CARD_KOZMO_DARK_DESTROYER] = 1,
    [ITEM_CARD_KOZMO_FARMGIRL] = 1,
    [ITEM_CARD_KOZMO_SLIPRIDER] = 1,
    [ITEM_CARD_KOZMO_TINCAN] = 1,
    [ITEM_CARD_KOZMOJO] = 1,
    [ITEM_CARD_KOZMOLL_WICKEDWITCH] = 1,
    [ITEM_CARD_KOZMOTOWN] = 1,
    [ITEM_CARD_KREBONS] = 1,
    [ITEM_CARD_KUMONGOUS_THE_STICKY_STRING_KAIJU] = 1,
    [ITEM_CARD_KURIBOH] = 1,
    [ITEM_CARD_KURIKARA_DIVINCARNATE] = 1,
    [ITEM_CARD_KYCOO_THE_GHOST_DESTROYER] = 1,
    [ITEM_CARD_LA_JINN_THE_MYSTICAL_GENIE_OF_THE_LAMP] = 1,
    [ITEM_CARD_LABRYNTH_ARCHFIEND] = 1,
    [ITEM_CARD_LABYRINTH_TANK] = 1,
    [ITEM_CARD_LACRIMA_THE_CRIMSON_TEARS] = 1,
    [ITEM_CARD_LADY_NINJA_YAE] = 1,
    [ITEM_CARD_LANCER_ARCHFIEND] = 1,
    [ITEM_CARD_LAST_WILL] = 1,
    [ITEM_CARD_LEECHING_THE_LIGHT] = 1,
    [ITEM_CARD_LEFT_ARM_OF_THE_FORBIDDEN_ONE] = 1,
    [ITEM_CARD_LEFT_LEG_OF_THE_FORBIDDEN_ONE] = 1,
    [ITEM_CARD_LEGACY_OF_YATA_GARASU] = 1,
    [ITEM_CARD_LEGENDARY_JUJITSU_MASTER] = 1,
    [ITEM_CARD_LEGENDARY_SIX_SAMURAI_KIZAN] = 1,
    [ITEM_CARD_LEOTRON] = 1,
    [ITEM_CARD_LESSER_FIEND] = 1,
    [ITEM_CARD_LEVEL_LIMIT_AREA_B] = 1,
    [ITEM_CARD_LEVIA_DRAGON_DAEDALUS] = 1,
    [ITEM_CARD_LEVIAIR_THE_SEA_DRAGON] = 1,
    [ITEM_CARD_LIBIC_MALEBRANCHE_OF_THE_BURNING_ABYSS] = 1,
    [ITEM_CARD_LIGHT_AND_DARKNESS_DRAGON] = 1,
    [ITEM_CARD_LIGHT_OF_INTERVENTION] = 1,
    [ITEM_CARD_LIGHT_IMPRISONING_MIRROR] = 1,
    [ITEM_CARD_LIGHTNING_STORM] = 1,
    [ITEM_CARD_LIGHTNING_VORTEX] = 1,
    [ITEM_CARD_LIGHTNING_DRAGON_RULER_OF_DRAFTS] = 1,
    [ITEM_CARD_LIGHTPULSAR_DRAGON] = 1,
    [ITEM_CARD_LIMITER_REMOVAL] = 1,
    [ITEM_CARD_LINK_SPIDER] = 1,
    [ITEM_CARD_LINKURIBOH] = 1,
    [ITEM_CARD_LONEFIRE_BLOSSOM] = 1,
    [ITEM_CARD_LORD_OF_D_] = 1,
    [ITEM_CARD_LUBELLION_THE_SEARING_DRAGON] = 1,
    [ITEM_CARD_LUCENT_NETHERLORD_OF_DARK_WORLD] = 1,
    [ITEM_CARD_LUCIUS_THE_SHADOW_VASSAL] = 1,
    [ITEM_CARD_LULLABY_OF_OBEDIENCE] = 1,
    [ITEM_CARD_LUMINA_LIGHTSWORN_SUMMONER] = 1,
    [ITEM_CARD_LUNALIGHT_BLACK_SHEEP] = 1,
    [ITEM_CARD_LUSTER_DRAGON] = 1,
    [ITEM_CARD_LUSTER_PENDULUM_THE_DRACOSLAYER] = 1,
    [ITEM_CARD_LYLA_LIGHTSWORN_SORCERESS] = 1,
    [ITEM_CARD_M_X_SABER_INVOKER] = 1,
    [ITEM_CARD_MACHINE_DUPLICATION] = 1,
    [ITEM_CARD_MACRO_COSMOS] = 1,
    [ITEM_CARD_MAD_ARCHFIEND] = 1,
    [ITEM_CARD_MAD_DOG_OF_DARKNESS] = 1,
    [ITEM_CARD_MAESTROKE_THE_SYMPHONY_DJINN] = 1,
    [ITEM_CARD_MAGE_POWER] = 1,
    [ITEM_CARD_MAGIC_CYLINDER] = 1,
    [ITEM_CARD_MAGIC_DEFLECTOR] = 1,
    [ITEM_CARD_MAGIC_JAMMER] = 1,
    [ITEM_CARD_MAGICAL_ABDUCTOR] = 1,
    [ITEM_CARD_MAGICAL_ANDROID] = 1,
    [ITEM_CARD_MAGICAL_DIMENSION] = 1,
    [ITEM_CARD_MAGICAL_MERCHANT] = 1,
    [ITEM_CARD_MAGICAL_SCIENTIST] = 1,
    [ITEM_CARD_MAGICIAN_OF_DARK_ILLUSION] = 1,
    [ITEM_CARD_MAGICIAN_OF_FAITH] = 1,
    [ITEM_CARD_MAGICIAN_S_CIRCLE] = 1,
    [ITEM_CARD_MAGICIAN_S_ROBE] = 1,
    [ITEM_CARD_MAGICIAN_S_ROD] = 1,
    [ITEM_CARD_MAGICIAN_S_VALKYRIA] = 1,
    [ITEM_CARD_MAGICIANS_SOULS] = 1,
    [ITEM_CARD_MAGIKURIBOH] = 1,
    [ITEM_CARD_MAIDEN_OF_THE_AQUA] = 1,
    [ITEM_CARD_MAIDEN_OF_WHITE] = 1,
    [ITEM_CARD_MAIDEN_WITH_EYES_OF_BLUE] = 1,
    [ITEM_CARD_MAJESPECTER_RACCOON_BUNBUKU] = 1,
    [ITEM_CARD_MAJESPECTER_UNICORN_KIRIN] = 1,
    [ITEM_CARD_MAJESTER_PALADIN_THE_ASCENDING_DRACOSLAYER] = 1,
    [ITEM_CARD_MAJESTY_S_FIEND] = 1,
    [ITEM_CARD_MAKYURA_THE_DESTRUCTOR] = 1,
    [ITEM_CARD_MALEFIC_BLUE_EYES_WHITE_DRAGON] = 1,
    [ITEM_CARD_MALEFIC_CYBER_END_DRAGON] = 1,
    [ITEM_CARD_MALEFIC_RED_EYES_BLACK_DRAGON] = 1,
    [ITEM_CARD_MALEVOLENT_CATASTROPHE] = 1,
    [ITEM_CARD_MALISS_IN_UNDERGROUND] = 1,
    [ITEM_CARD_MALISS_P_DORMOUSE] = 1,
    [ITEM_CARD_MALISS_P_WHITE_RABBIT] = 1,
    [ITEM_CARD_MAN_EATER_BUG] = 1,
    [ITEM_CARD_MANJU_OF_THE_TEN_THOUSAND_HANDS] = 1,
    [ITEM_CARD_MANTICORE_OF_DARKNESS] = 1,
    [ITEM_CARD_MARAUDING_CAPTAIN] = 1,
    [ITEM_CARD_MASK_OF_DARKNESS] = 1,
    [ITEM_CARD_MASK_OF_RESTRICT] = 1,
    [ITEM_CARD_MASKED_DRAGON] = 1,
    [ITEM_CARD_MASKED_NINJA_EBISU] = 1,
    [ITEM_CARD_MASKED_SORCERER] = 1,
    [ITEM_CARD_MASTER_HYPERION] = 1,
    [ITEM_CARD_MASTER_OF_CHAOS] = 1,
    [ITEM_CARD_MASTER_OF_OZ] = 1,
    [ITEM_CARD_MASTER_PEACE_THE_TRUE_DRACOSLAYING_KING] = 1,
    [ITEM_CARD_MASTER_PENDULUM_THE_DRACOSLAYER] = 1,
    [ITEM_CARD_MASTER_WITH_EYES_OF_BLUE] = 1,
    [ITEM_CARD_MATAZA_THE_ZAPPER] = 1,
    [ITEM_CARD_MATHEMATICIAN] = 1,
    [ITEM_CARD_MATRIARCH_OF_NEPHTHYS] = 1,
    [ITEM_CARD_MAXX_C_] = 1,
    [ITEM_CARD_MECHA_PHANTOM_BEAST_DRACOSSACK] = 1,
    [ITEM_CARD_MECHANICALCHASER] = 1,
    [ITEM_CARD_MEGALOSMASHER_X] = 1,
    [ITEM_CARD_MEGAMORPH] = 1,
    [ITEM_CARD_MEIZEN_THE_BATTLE_NINJA] = 1,
    [ITEM_CARD_MEKK_KNIGHT_AVRAM] = 1,
    [ITEM_CARD_MEREOLOGIC_AGGREGATOR] = 1,
    [ITEM_CARD_MERMAID_KNIGHT] = 1,
    [ITEM_CARD_MERMAIL_ABYSSGAIOS] = 1,
    [ITEM_CARD_MERMAIL_ABYSSGUNDE] = 1,
    [ITEM_CARD_MERMAIL_ABYSSLINDE] = 1,
    [ITEM_CARD_MERMAIL_ABYSSMEGALO] = 1,
    [ITEM_CARD_MERMAIL_ABYSSPIKE] = 1,
    [ITEM_CARD_MERMAIL_ABYSSTEUS] = 1,
    [ITEM_CARD_MERMAIL_ABYSSTRITE] = 1,
    [ITEM_CARD_MERMAIL_ABYSSTURGE] = 1,
    [ITEM_CARD_MESSENGER_OF_PEACE] = 1,
    [ITEM_CARD_METAL_REFLECT_SLIME] = 1,
    [ITEM_CARD_METALFLAME_SWORDSMAN] = 1,
    [ITEM_CARD_METALFOES_GOLDRIVER] = 1,
    [ITEM_CARD_METALFOES_SILVERD] = 1,
    [ITEM_CARD_METALFOES_STEELEN] = 1,
    [ITEM_CARD_METALFOES_VOLFLAME] = 1,
    [ITEM_CARD_METALTRONUS] = 1,
    [ITEM_CARD_METAMORPHOSIS] = 1,
    [ITEM_CARD_METEOR_BLACK_COMET_DRAGON] = 1,
    [ITEM_CARD_METEOR_DRAGON] = 1,
    [ITEM_CARD_MEZUKI] = 1,
    [ITEM_CARD_MILUS_RADIANT] = 1,
    [ITEM_CARD_MINAR] = 1,
    [ITEM_CARD_MIND_CONTROL] = 1,
    [ITEM_CARD_MIND_CRUSH] = 1,
    [ITEM_CARD_MIND_PROTECTOR] = 1,
    [ITEM_CARD_MINE_GOLEM] = 1,
    [ITEM_CARD_MIRACLE_RESTORING] = 1,
    [ITEM_CARD_MIRAGE_DRAGON] = 1,
    [ITEM_CARD_MIRAGE_KNIGHT] = 1,
    [ITEM_CARD_MIRAGE_OF_NIGHTMARE] = 1,
    [ITEM_CARD_MIRAGE_SWORDSMAN] = 1,
    [ITEM_CARD_MIRROR_FORCE] = 1,
    [ITEM_CARD_MIRROR_OF_OATHS] = 1,
    [ITEM_CARD_MISSUS_RADIANT] = 1,
    [ITEM_CARD_MIST_WURM] = 1,
    [ITEM_CARD_MISTAKE] = 1,
    [ITEM_CARD_MITSU_THE_INSECT_NINJA] = 1,
    [ITEM_CARD_MOAI_INTERCEPTOR_CANNONS] = 1,
    [ITEM_CARD_MOBIUS_THE_FROST_MONARCH] = 1,
    [ITEM_CARD_MOBIUS_THE_MEGA_MONARCH] = 1,
    [ITEM_CARD_MONK_OF_THE_TENYI] = 1,
    [ITEM_CARD_MONSTER_GATE] = 1,
    [ITEM_CARD_MONSTER_REBORN] = 1,
    [ITEM_CARD_MONSTER_REINCARNATION] = 1,
    [ITEM_CARD_MOON_OF_THE_CLOSED_HEAVEN] = 1,
    [ITEM_CARD_MORPHING_JAR] = 1,
    [ITEM_CARD_MORPHING_JAR_2] = 1,
    [ITEM_CARD_MOTHER_GRIZZLY] = 1,
    [ITEM_CARD_MUDORA_THE_SWORD_ORACLE] = 1,
    [ITEM_CARD_MUDRAGON_OF_THE_SWAMP] = 1,
    [ITEM_CARD_MUKA_MUKA] = 1,
    [ITEM_CARD_MULCHARMY_FUWALOS] = 1,
    [ITEM_CARD_MULCHARMY_MEOWLS] = 1,
    [ITEM_CARD_MULCHARMY_PURULIA] = 1,
    [ITEM_CARD_MY_BODY_AS_A_SHIELD] = 1,
    [ITEM_CARD_MYSTERY_SHELL_DRAGON] = 1,
    [ITEM_CARD_MYSTIC_MINE] = 1,
    [ITEM_CARD_MYSTIC_SWORDSMAN_LV2] = 1,
    [ITEM_CARD_MYSTIC_SWORDSMAN_LV4] = 1,
    [ITEM_CARD_MYSTIC_TOMATO] = 1,
    [ITEM_CARD_MYSTICAL_ELF] = 1,
    [ITEM_CARD_MYSTICAL_ELF_WHITE_LIGHTNING] = 1,
    [ITEM_CARD_MYSTICAL_SPACE_TYPHOON] = 1,
    [ITEM_CARD_MYSTIK_WOK] = 1,
    [ITEM_CARD_NAELSHADDOLL_ARIEL] = 1,
    [ITEM_CARD_NECRO_GARDNA] = 1,
    [ITEM_CARD_NECROVALLEY] = 1,
    [ITEM_CARD_NEEDLE_CEILING] = 1,
    [ITEM_CARD_NEKO_MANE_KING] = 1,
    [ITEM_CARD_NEKROZ_CYCLE] = 1,
    [ITEM_CARD_NEKROZ_KALEIDOSCOPE] = 1,
    [ITEM_CARD_NEKROZ_MIRROR] = 1,
    [ITEM_CARD_NEKROZ_OF_BRIONAC] = 1,
    [ITEM_CARD_NEKROZ_OF_CLAUSOLAS] = 1,
    [ITEM_CARD_NEKROZ_OF_UNICORE] = 1,
    [ITEM_CARD_NEKROZ_OF_VALKYRUS] = 1,
    [ITEM_CARD_NEO_BUG] = 1,
    [ITEM_CARD_NEO_KAISER_SEA_HORSE] = 1,
    [ITEM_CARD_NEO_THE_MAGIC_SWORDSMAN] = 1,
    [ITEM_CARD_NEO_SPACIAN_DARK_PANTHER] = 1,
    [ITEM_CARD_NEWDORIA] = 1,
    [ITEM_CARD_NIBIRU_THE_PRIMAL_BEING] = 1,
    [ITEM_CARD_NIGHT_ASSAILANT] = 1,
    [ITEM_CARD_NIGHT_BEAM] = 1,
    [ITEM_CARD_NIGHTMARE_MAGICIAN] = 1,
    [ITEM_CARD_NIGHTMARE_WHEEL] = 1,
    [ITEM_CARD_NIGHTMARE_S_STEELCAGE] = 1,
    [ITEM_CARD_NIMBLE_ANGLER] = 1,
    [ITEM_CARD_NIMBLE_BEAVER] = 1,
    [ITEM_CARD_NIMBLE_MOMONGA] = 1,
    [ITEM_CARD_NIN_KEN_DOG] = 1,
    [ITEM_CARD_NINJA_GRANDMASTER_HANZO] = 1,
    [ITEM_CARD_NINJA_GRANDMASTER_SASUKE] = 1,
    [ITEM_CARD_NOBLEMAN_OF_CROSSOUT] = 1,
    [ITEM_CARD_NOBLEMAN_OF_EXTERMINATION] = 1,
    [ITEM_CARD_NUMBER_101_SILENT_HONOR_ARK] = 1,
    [ITEM_CARD_NUMBER_11_BIG_EYE] = 1,
    [ITEM_CARD_NUMBER_17_LEVIATHAN_DRAGON] = 1,
    [ITEM_CARD_NUMBER_30_ACID_GOLEM_OF_DESTRUCTION] = 1,
    [ITEM_CARD_NUMBER_39_UTOPIA] = 1,
    [ITEM_CARD_NUMBER_41_BAGOOSKA_THE_TERRIBLY_TIRED_TAPIR] = 1,
    [ITEM_CARD_NUMBER_66_MASTER_KEY_BEETLE] = 1,
    [ITEM_CARD_OFFERINGS_TO_THE_DOOMED] = 1,
    [ITEM_CARD_OJAMA_KING] = 1,
    [ITEM_CARD_OJAMA_TRIO] = 1,
    [ITEM_CARD_OOKAZI] = 1,
    [ITEM_CARD_OPPRESSED_PEOPLE] = 1,
    [ITEM_CARD_OPTICLOPS] = 1,
    [ITEM_CARD_ORCUST_CYMBAL_SKELETON] = 1,
    [ITEM_CARD_ORCUST_HARP_HORROR] = 1,
    [ITEM_CARD_ORCUST_KNIGHTMARE] = 1,
    [ITEM_CARD_ORCUSTRATED_RETURN] = 1,
    [ITEM_CARD_ORIGINAL_SINFUL_SPOILS_SNAKE_EYE] = 1,
    [ITEM_CARD_OVERLOAD_FUSION] = 1,
    [ITEM_CARD_PAINFUL_CHOICE] = 1,
    [ITEM_CARD_PAINFUL_DECISION] = 1,
    [ITEM_CARD_PALADIN_OF_WHITE_DRAGON] = 1,
    [ITEM_CARD_PALEOZOIC_ANOMALOCARIS] = 1,
    [ITEM_CARD_PALEOZOIC_CANADIA] = 1,
    [ITEM_CARD_PALEOZOIC_DINOMISCHUS] = 1,
    [ITEM_CARD_PALEOZOIC_MARRELLA] = 1,
    [ITEM_CARD_PALEOZOIC_OLENOIDES] = 1,
    [ITEM_CARD_PALEOZOIC_OPABINIA] = 1,
    [ITEM_CARD_PALLADIUM_ORACLE_MAHAD] = 1,
    [ITEM_CARD_PANTHEISM_OF_THE_MONARCHS] = 1,
    [ITEM_CARD_PARL_HERMIT_OF_DARK_WORLD] = 1,
    [ITEM_CARD_PENGUIN_KNIGHT] = 1,
    [ITEM_CARD_PENGUIN_NINJA] = 1,
    [ITEM_CARD_PERFORMAGE_DAMAGE_JUGGLER] = 1,
    [ITEM_CARD_PERFORMAGE_HAT_TRICKER] = 1,
    [ITEM_CARD_PERFORMAGE_MIRROR_CONDUCTOR] = 1,
    [ITEM_CARD_PERFORMAGE_PLUSHFIRE] = 1,
    [ITEM_CARD_PERFORMAGE_TRAPEZE_MAGICIAN] = 1,
    [ITEM_CARD_PERFORMAGE_TRICK_CLOWN] = 1,
    [ITEM_CARD_PERFORMAPAL_GUITARTLE] = 1,
    [ITEM_CARD_PERFORMAPAL_LIZARDRAW] = 1,
    [ITEM_CARD_PERFORMAPAL_MONKEYBOARD] = 1,
    [ITEM_CARD_PERFORMAPAL_PENDULUM_SORCERER] = 1,
    [ITEM_CARD_PERFORMAPAL_SILVER_CLAW] = 1,
    [ITEM_CARD_PERFORMAPAL_SKULLCROBAT_JOKER] = 1,
    [ITEM_CARD_PHANTOM_GRYPHON] = 1,
    [ITEM_CARD_PHANTOM_KNIGHTS_FOG_BLADE] = 1,
    [ITEM_CARD_PHOENIX_WING_WIND_BLAST] = 1,
    [ITEM_CARD_PIKERU_S_CIRCLE_OF_ENCHANTMENT] = 1,
    [ITEM_CARD_PINCH_HOPPER] = 1,
    [ITEM_CARD_PITCH_BLACK_POWER_STONE] = 1,
    [ITEM_CARD_PLAGUESPREADER_ZOMBIE] = 1,
    [ITEM_CARD_POISON_OF_THE_OLD_MAN] = 1,
    [ITEM_CARD_POLYMERIZATION] = 1,
    [ITEM_CARD_POT_OF_AVARICE] = 1,
    [ITEM_CARD_POT_OF_DESIRES] = 1,
    [ITEM_CARD_POT_OF_DUALITY] = 1,
    [ITEM_CARD_POT_OF_GENEROSITY] = 1,
    [ITEM_CARD_POT_OF_GREED] = 1,
    [ITEM_CARD_POT_OF_PROSPERITY] = 1,
    [ITEM_CARD_PRANK_KIDS_DODO_DOODLE_DOO] = 1,
    [ITEM_CARD_PRANK_KIDS_DROPSIES] = 1,
    [ITEM_CARD_PRANK_KIDS_FANSIES] = 1,
    [ITEM_CARD_PRANK_KIDS_LAMPSIES] = 1,
    [ITEM_CARD_PRANK_KIDS_PLACE] = 1,
    [ITEM_CARD_PRANK_KIDS_ROCKSIES] = 1,
    [ITEM_CARD_PREDAPLANT_DRAGOSTAPELIA] = 1,
    [ITEM_CARD_PREDAPLANT_VERTE_ANACONDA] = 1,
    [ITEM_CARD_PREMATURE_BURIAL] = 1,
    [ITEM_CARD_PRESSURED_PLANET_WRAITSOTH] = 1,
    [ITEM_CARD_PREVENT_RAT] = 1,
    [ITEM_CARD_PRICKLE_FAIRY] = 1,
    [ITEM_CARD_PRIESTESS_WITH_EYES_OF_BLUE] = 1,
    [ITEM_CARD_PRIMAL_DRAGON_THE_PRIMORDIAL] = 1,
    [ITEM_CARD_PRIMEVAL_PLANET_PERLEREINO] = 1,
    [ITEM_CARD_PRINCESS_OF_TSURUGI] = 1,
    [ITEM_CARD_PROHIBITION] = 1,
    [ITEM_CARD_PROMETHEAN_PRINCESS_BESTOWER_OF_FLAMES] = 1,
    [ITEM_CARD_PROTECTOR_OF_THE_SANCTUARY] = 1,
    [ITEM_CARD_PROTECTOR_WITH_EYES_OF_BLUE] = 1,
    [ITEM_CARD_PSI_BLOCKER] = 1,
    [ITEM_CARD_PSY_FRAME_DRIVER] = 1,
    [ITEM_CARD_PSY_FRAMEGEAR_GAMMA] = 1,
    [ITEM_CARD_PULLING_THE_RUG] = 1,
    [ITEM_CARD_PUNISHED_EAGLE] = 1,
    [ITEM_CARD_PUPPET_PLANT] = 1,
    [ITEM_CARD_PYRAMID_TURTLE] = 1,
    [ITEM_CARD_QADSHADDOLL_KEIOS] = 1,
    [ITEM_CARD_QLIPHORT_CARRIER] = 1,
    [ITEM_CARD_QLIPHORT_DISK] = 1,
    [ITEM_CARD_QLIPHORT_HELIX] = 1,
    [ITEM_CARD_QLIPHORT_SCOUT] = 1,
    [ITEM_CARD_RAIGEKI] = 1,
    [ITEM_CARD_RAIGEKI_BREAK] = 1,
    [ITEM_CARD_RAIZA_THE_MEGA_MONARCH] = 1,
    [ITEM_CARD_RAIZA_THE_STORM_MONARCH] = 1,
    [ITEM_CARD_REACTAN_DRAGON_RULER_OF_PEBBLES] = 1,
    [ITEM_CARD_REAPER_ON_THE_NIGHTMARE] = 1,
    [ITEM_CARD_REASONING] = 1,
    [ITEM_CARD_REBORN_TENGU] = 1,
    [ITEM_CARD_RECKLESS_GREED] = 1,
    [ITEM_CARD_RED_DRAGON_ARCHFIEND] = 1,
    [ITEM_CARD_RED_DRAGON_NINJA] = 1,
    [ITEM_CARD_RED_REBOOT] = 1,
    [ITEM_CARD_RED_EYES_ALTERNATIVE_BLACK_DRAGON] = 1,
    [ITEM_CARD_RED_EYES_BABY_DRAGON] = 1,
    [ITEM_CARD_RED_EYES_BLACK_DRAGON] = 1,
    [ITEM_CARD_RED_EYES_BLACK_DRAGON_SWORD] = 1,
    [ITEM_CARD_RED_EYES_BLACK_FULLMETAL_DRAGON] = 1,
    [ITEM_CARD_RED_EYES_BLACK_METAL_DRAGON] = 1,
    [ITEM_CARD_RED_EYES_BLACK_METEOR_DRAGON] = 1,
    [ITEM_CARD_RED_EYES_DARKNESS_METAL_DRAGON] = 1,
    [ITEM_CARD_RED_EYES_RETRO_DRAGON] = 1,
    [ITEM_CARD_RED_EYES_SLASH_DRAGON] = 1,
    [ITEM_CARD_RED_EYES_SOUL] = 1,
    [ITEM_CARD_RED_EYES_TOON_DRAGON] = 1,
    [ITEM_CARD_RED_EYES_WYVERN] = 1,
    [ITEM_CARD_RED_EYES_ZOMBIE_DRAGON] = 1,
    [ITEM_CARD_REDOX_DRAGON_RULER_OF_BOULDERS] = 1,
    [ITEM_CARD_REESHADDOLL_WENDI] = 1,
    [ITEM_CARD_REFLECT_BOUNDER] = 1,
    [ITEM_CARD_REIGN_BEAUX_OVERKING_OF_DARK_WORLD] = 1,
    [ITEM_CARD_REIGN_BEAUX_OVERLORD_OF_DARK_WORLD] = 1,
    [ITEM_CARD_REINFORCEMENT_OF_THE_ARMY] = 1,
    [ITEM_CARD_REINFORCEMENTS] = 1,
    [ITEM_CARD_RELINKURIBOH] = 1,
    [ITEM_CARD_RELINQUISHED] = 1,
    [ITEM_CARD_RELINQUISHED_ANIMA] = 1,
    [ITEM_CARD_RELOAD] = 1,
    [ITEM_CARD_REMOVE_TRAP] = 1,
    [ITEM_CARD_RENGE_GATEKEEPER_OF_DARK_WORLD] = 1,
    [ITEM_CARD_RESCUE_CAT] = 1,
    [ITEM_CARD_RESCUE_RABBIT] = 1,
    [ITEM_CARD_RETALIATING_C_] = 1,
    [ITEM_CARD_RETURN_FROM_THE_DIFFERENT_DIMENSION] = 1,
    [ITEM_CARD_RIDER_OF_THE_STORM_WINDS] = 1,
    [ITEM_CARD_RIGHT_ARM_OF_THE_FORBIDDEN_ONE] = 1,
    [ITEM_CARD_RIGHT_LEG_OF_THE_FORBIDDEN_ONE] = 1,
    [ITEM_CARD_RING_OF_DESTRUCTION] = 1,
    [ITEM_CARD_RISING_AIR_CURRENT] = 1,
    [ITEM_CARD_RITE_OF_ARAMESIR] = 1,
    [ITEM_CARD_RIVALRY_OF_WARLORDS] = 1,
    [ITEM_CARD_ROARING_OCEAN_SNAKE] = 1,
    [ITEM_CARD_ROBBIN_GOBLIN] = 1,
    [ITEM_CARD_RONINTOADIN] = 1,
    [ITEM_CARD_ROULETTE_BARREL] = 1,
    [ITEM_CARD_ROYAL_DECREE] = 1,
    [ITEM_CARD_ROYAL_MAGICAL_LIBRARY] = 1,
    [ITEM_CARD_ROYAL_OPPRESSION] = 1,
    [ITEM_CARD_RUBIC_MALEBRANCHE_OF_THE_BURNING_ABYSS] = 1,
    [ITEM_CARD_RUNICK_DESTRUCTION] = 1,
    [ITEM_CARD_RUNICK_FLASHING_FIRE] = 1,
    [ITEM_CARD_RUNICK_FREEZING_CURSES] = 1,
    [ITEM_CARD_RUNICK_TIP] = 1,
    [ITEM_CARD_RUSH_RECKLESSLY] = 1,
    [ITEM_CARD_RYKO_LIGHTSWORN_HUNTER] = 1,
    [ITEM_CARD_RYU_KOKKI] = 1,
    [ITEM_CARD_RYU_SENSHI] = 1,
    [ITEM_CARD_RYZEAL_CROSS] = 1,
    [ITEM_CARD_RYZEAL_DETONATOR] = 1,
    [ITEM_CARD_RYZEAL_DUO_DRIVE] = 1,
    [ITEM_CARD_S_P_LITTLE_KNIGHT] = 1,
    [ITEM_CARD_SABER_BEETLE] = 1,
    [ITEM_CARD_SABERSAURUS] = 1,
    [ITEM_CARD_SACRED_CRANE] = 1,
    [ITEM_CARD_SACRED_PHOENIX_OF_NEPHTHYS] = 1,
    [ITEM_CARD_SACRED_SWORD_OF_SEVEN_STARS] = 1,
    [ITEM_CARD_SAGE_WITH_EYES_OF_BLUE] = 1,
    [ITEM_CARD_SAKURETSU_ARMOR] = 1,
    [ITEM_CARD_SALAMANDRA_THE_FLYING_FLAME_DRAGON] = 1,
    [ITEM_CARD_SALAMANGREAT_BALELYNX] = 1,
    [ITEM_CARD_SALAMANGREAT_FOXY] = 1,
    [ITEM_CARD_SALAMANGREAT_RAGING_PHOENIX] = 1,
    [ITEM_CARD_SALAMANGREAT_SPINNY] = 1,
    [ITEM_CARD_SALAMANGREAT_SUNLIGHT_WOLF] = 1,
    [ITEM_CARD_SALVAGE] = 1,
    [ITEM_CARD_SAND_MOTH] = 1,
    [ITEM_CARD_SANGAN] = 1,
    [ITEM_CARD_SANGEN_KAIMEN] = 1,
    [ITEM_CARD_SANGEN_SUMMONING] = 1,
    [ITEM_CARD_SAQLIFICE] = 1,
    [ITEM_CARD_SASUKE_SAMURAI] = 1,
    [ITEM_CARD_SASUKE_SAMURAI_4] = 1,
    [ITEM_CARD_SCAPEGOAT] = 1,
    [ITEM_CARD_SCARM_MALEBRANCHE_OF_THE_BURNING_ABYSS] = 1,
    [ITEM_CARD_SCARR_SCOUT_OF_DARK_WORLD] = 1,
    [ITEM_CARD_SCRAP_DRAGON] = 1,
    [ITEM_CARD_SEA_SERPENT_WARRIOR_OF_DARKNESS] = 1,
    [ITEM_CARD_SECOND_COIN_TOSS] = 1,
    [ITEM_CARD_SECRET_BARREL] = 1,
    [ITEM_CARD_SELF_DESTRUCT_BUTTON] = 1,
    [ITEM_CARD_SENIOR_SILVER_NINJA] = 1,
    [ITEM_CARD_SENJU_OF_THE_THOUSAND_HANDS] = 1,
    [ITEM_CARD_SERIAL_SPELL] = 1,
    [ITEM_CARD_SERPENTINE_PRINCESS] = 1,
    [ITEM_CARD_SEVEN_TOOLS_OF_THE_BANDIT] = 1,
    [ITEM_CARD_SHADDOLL_BEAST] = 1,
    [ITEM_CARD_SHADDOLL_DRAGON] = 1,
    [ITEM_CARD_SHADDOLL_FALCO] = 1,
    [ITEM_CARD_SHADDOLL_FUSION] = 1,
    [ITEM_CARD_SHADDOLL_HEDGEHOG] = 1,
    [ITEM_CARD_SHADDOLL_HOUND] = 1,
    [ITEM_CARD_SHADDOLL_SQUAMATA] = 1,
    [ITEM_CARD_SHADOW_IMPRISONING_MIRROR] = 1,
    [ITEM_CARD_SHARED_RIDE] = 1,
    [ITEM_CARD_SHIEN_S_SMOKE_SIGNAL] = 1,
    [ITEM_CARD_SHINING_ANGEL] = 1,
    [ITEM_CARD_SHINY_BLACK_C_] = 1,
    [ITEM_CARD_SHINY_BLACK_C_SQUADDER] = 1,
    [ITEM_CARD_SHRINK] = 1,
    [ITEM_CARD_SHUFFLE_REBORN] = 1,
    [ITEM_CARD_SHURIT_STRATEGIST_OF_THE_NEKROZ] = 1,
    [ITEM_CARD_SILLVA_WARLORD_OF_DARK_WORLD] = 1,
    [ITEM_CARD_SILPHEED] = 1,
    [ITEM_CARD_SINISTER_SERPENT] = 1,
    [ITEM_CARD_SINISTER_SHADOW_GAMES] = 1,
    [ITEM_CARD_SIX_SAMURAI_UNITED] = 1,
    [ITEM_CARD_SKILL_DRAIN] = 1,
    [ITEM_CARD_SKILLED_DARK_MAGICIAN] = 1,
    [ITEM_CARD_SKILLED_RED_MAGICIAN] = 1,
    [ITEM_CARD_SKILLED_WHITE_MAGICIAN] = 1,
    [ITEM_CARD_SKULL_DOG_MARRON] = 1,
    [ITEM_CARD_SKULL_LAIR] = 1,
    [ITEM_CARD_SKY_IRIS] = 1,
    [ITEM_CARD_SKY_SCOUT] = 1,
    [ITEM_CARD_SKY_STRIKER_ACE_KAGARI] = 1,
    [ITEM_CARD_SKY_STRIKER_ACE_RAYE] = 1,
    [ITEM_CARD_SKY_STRIKER_ACE_ROZE] = 1,
    [ITEM_CARD_SKY_STRIKER_ACE_SHIZUKU] = 1,
    [ITEM_CARD_SKY_STRIKER_MANEUVER_AFTERBURNERS_] = 1,
    [ITEM_CARD_SKY_STRIKER_MECHA_HORNET_DRONES] = 1,
    [ITEM_CARD_SKY_STRIKER_MECHA_SHARK_CANNON] = 1,
    [ITEM_CARD_SKY_STRIKER_MECHA_WIDOW_ANCHOR] = 1,
    [ITEM_CARD_SKY_STRIKER_MOBILIZE_ENGAGE_] = 1,
    [ITEM_CARD_SLATE_WARRIOR] = 1,
    [ITEM_CARD_SMASHING_GROUND] = 1,
    [ITEM_CARD_SNAKE_EYE_ASH] = 1,
    [ITEM_CARD_SNAKE_EYE_BIRCH] = 1,
    [ITEM_CARD_SNAKE_EYE_OAK] = 1,
    [ITEM_CARD_SNAKE_EYES_DIABELLSTAR] = 1,
    [ITEM_CARD_SNAKE_EYES_FLAMBERGE_DRAGON] = 1,
    [ITEM_CARD_SNAKE_EYES_POPLAR] = 1,
    [ITEM_CARD_SNATCH_STEAL] = 1,
    [ITEM_CARD_SNIPE_HUNTER] = 1,
    [ITEM_CARD_SNOWMAN_EATER] = 1,
    [ITEM_CARD_SNOWW_UNLIGHT_OF_DARK_WORLD] = 1,
    [ITEM_CARD_SOLAR_RECHARGE] = 1,
    [ITEM_CARD_SOLEMN_JUDGMENT] = 1,
    [ITEM_CARD_SOLEMN_STRIKE] = 1,
    [ITEM_CARD_SOLEMN_WARNING] = 1,
    [ITEM_CARD_SOLEMN_WISHES] = 1,
    [ITEM_CARD_SONIC_BIRD] = 1,
    [ITEM_CARD_SOUL_CHARGE] = 1,
    [ITEM_CARD_SOUL_EXCHANGE] = 1,
    [ITEM_CARD_SOUL_TAKER] = 1,
    [ITEM_CARD_SOUL_TIGER] = 1,
    [ITEM_CARD_SPEAR_CRETIN] = 1,
    [ITEM_CARD_SPEAR_DRAGON] = 1,
    [ITEM_CARD_SPEEDROID_TAKETOMBORG] = 1,
    [ITEM_CARD_SPEEDROID_TERRORTOP] = 1,
    [ITEM_CARD_SPELL_CANCELLER] = 1,
    [ITEM_CARD_SPELL_REPRODUCTION] = 1,
    [ITEM_CARD_SPELL_SHATTERING_ARROW] = 1,
    [ITEM_CARD_SPELLBOOK_MAGICIAN_OF_PROPHECY] = 1,
    [ITEM_CARD_SPELLBOOK_OF_JUDGMENT] = 1,
    [ITEM_CARD_SPELLBOOK_OF_SECRETS] = 1,
    [ITEM_CARD_SPHERE_KURIBOH] = 1,
    [ITEM_CARD_SPIRIT_OF_THE_HARP] = 1,
    [ITEM_CARD_SPIRIT_REAPER] = 1,
    [ITEM_CARD_SPIRITUAL_EARTH_ART_KUROGANE] = 1,
    [ITEM_CARD_SPIRITUAL_WATER_ART_AOI] = 1,
    [ITEM_CARD_SPIRITUAL_WIND_ART_MIYABI] = 1,
    [ITEM_CARD_SPIRITUALISM] = 1,
    [ITEM_CARD_SPRIGHT_BLUE] = 1,
    [ITEM_CARD_SPRIGHT_CARROT] = 1,
    [ITEM_CARD_SPRIGHT_ELF] = 1,
    [ITEM_CARD_SPRIGHT_JET] = 1,
    [ITEM_CARD_SPRIGHT_RED] = 1,
    [ITEM_CARD_SPRIGHT_SMASHERS] = 1,
    [ITEM_CARD_SPRIGHT_SPRIND] = 1,
    [ITEM_CARD_SPRIGHT_STARTER] = 1,
    [ITEM_CARD_STARDUST_DRAGON] = 1,
    [ITEM_CARD_STARLIGHT_ROAD] = 1,
    [ITEM_CARD_STEALTH_BIRD] = 1,
    [ITEM_CARD_STEELSWARM_ROACH] = 1,
    [ITEM_CARD_STONE_STATUE_OF_THE_AZTECS] = 1,
    [ITEM_CARD_STOP_DEFENSE] = 1,
    [ITEM_CARD_STREAM_DRAGON_RULER_OF_DROPLETS] = 1,
    [ITEM_CARD_STRIKE_NINJA] = 1,
    [ITEM_CARD_SUBSTITOAD] = 1,
    [ITEM_CARD_SUMMON_LIMIT] = 1,
    [ITEM_CARD_SUMMONED_SKULL] = 1,
    [ITEM_CARD_SUMMONER_MONK] = 1,
    [ITEM_CARD_SUMMONER_S_ART] = 1,
    [ITEM_CARD_SUPER_POLYMERIZATION] = 1,
    [ITEM_CARD_SUPER_REJUVENATION] = 1,
    [ITEM_CARD_SUPER_SOLDIER_SOUL] = 1,
    [ITEM_CARD_SUPER_STARSLAYER_TY_PHON_SKY_CRISIS] = 1,
    [ITEM_CARD_SWAP_FROG] = 1,
    [ITEM_CARD_SWARM_OF_LOCUSTS] = 1,
    [ITEM_CARD_SWARM_OF_SCARABS] = 1,
    [ITEM_CARD_SWIFT_SCARECROW] = 1,
    [ITEM_CARD_SWORD_RYZEAL] = 1,
    [ITEM_CARD_SWORDS_OF_REVEALING_LIGHT] = 1,
    [ITEM_CARD_SWORDSOUL_BLACKOUT] = 1,
    [ITEM_CARD_SWORDSOUL_EMERGENCE] = 1,
    [ITEM_CARD_SWORDSOUL_GRANDMASTER_CHIXIAO] = 1,
    [ITEM_CARD_SWORDSOUL_OF_MO_YE] = 1,
    [ITEM_CARD_SWORDSOUL_OF_TAIA] = 1,
    [ITEM_CARD_SWORDSOUL_STRATEGIST_LONGYUAN] = 1,
    [ITEM_CARD_SYSTEM_DOWN] = 1,
    [ITEM_CARD_T_A_D_P_O_L_E_] = 1,
    [ITEM_CARD_T_G_RUSH_RHINO] = 1,
    [ITEM_CARD_T_G_STRIKER] = 1,
    [ITEM_CARD_T_G_WARWOLF] = 1,
    [ITEM_CARD_TEARLAMENTS_CRYME] = 1,
    [ITEM_CARD_TEARLAMENTS_HAVNIS] = 1,
    [ITEM_CARD_TEARLAMENTS_HEARTBEAT] = 1,
    [ITEM_CARD_TEARLAMENTS_KALEIDO_HEART] = 1,
    [ITEM_CARD_TEARLAMENTS_KASHTIRA] = 1,
    [ITEM_CARD_TEARLAMENTS_KITKALLOS] = 1,
    [ITEM_CARD_TEARLAMENTS_MERRLI] = 1,
    [ITEM_CARD_TEARLAMENTS_REINOHEART] = 1,
    [ITEM_CARD_TEARLAMENTS_RULKALLOS] = 1,
    [ITEM_CARD_TEARLAMENTS_SCHEIREN] = 1,
    [ITEM_CARD_TEARLAMENTS_SCREAM] = 1,
    [ITEM_CARD_TEARLAMENTS_SULLIEK] = 1,
    [ITEM_CARD_TELLARKNIGHT_PTOLEMAEUS] = 1,
    [ITEM_CARD_TEMPEST_MAGICIAN] = 1,
    [ITEM_CARD_TEMPEST_DRAGON_RULER_OF_STORMS] = 1,
    [ITEM_CARD_TEMTEMPO_THE_PERCUSSION_DJINN] = 1,
    [ITEM_CARD_TENACITY_OF_THE_MONARCHS] = 1,
    [ITEM_CARD_TENMATAITEI] = 1,
    [ITEM_CARD_TENPAI_DRAGON_CHUNDRA] = 1,
    [ITEM_CARD_TENPAI_DRAGON_FADRA] = 1,
    [ITEM_CARD_TENYI_SPIRIT_ADHARA] = 1,
    [ITEM_CARD_TENYI_SPIRIT_ASHUNA] = 1,
    [ITEM_CARD_TENYI_SPIRIT_VISHUDA] = 1,
    [ITEM_CARD_TERRAFORMING] = 1,
    [ITEM_CARD_TERRORKING_SALMON] = 1,
    [ITEM_CARD_TEST_TIGER] = 1,
    [ITEM_CARD_TG1_EM1] = 1,
    [ITEM_CARD_THAT_GRASS_LOOKS_GREENER] = 1,
    [ITEM_CARD_THE_AGENT_OF_MIRACLES_JUPITER] = 1,
    [ITEM_CARD_THE_AGENT_OF_MYSTERY_EARTH] = 1,
    [ITEM_CARD_THE_BIG_MARCH_OF_ANIMALS] = 1,
    [ITEM_CARD_THE_BLACK_STONE_OF_LEGEND] = 1,
    [ITEM_CARD_THE_BYSTIAL_ALUBER] = 1,
    [ITEM_CARD_THE_BYSTIAL_LUBELLION] = 1,
    [ITEM_CARD_THE_DARK_HEX_SEALED_FUSION] = 1,
    [ITEM_CARD_THE_DARK_MAGICIANS] = 1,
    [ITEM_CARD_THE_DRAGON_DWELLING_IN_THE_CAVE] = 1,
    [ITEM_CARD_THE_EARTH_HEX_SEALED_FUSION] = 1,
    [ITEM_CARD_THE_FIEND_MEGACYBER] = 1,
    [ITEM_CARD_THE_FORCEFUL_SENTRY] = 1,
    [ITEM_CARD_THE_FORGIVING_MAIDEN] = 1,
    [ITEM_CARD_THE_GOLDEN_SWORDSOUL] = 1,
    [ITEM_CARD_THE_LAST_WARRIOR_FROM_ANOTHER_PLANET] = 1,
    [ITEM_CARD_THE_LIGHT_HEX_SEALED_FUSION] = 1,
    [ITEM_CARD_THE_LITTLE_SWORDSMAN_OF_AILE] = 1,
    [ITEM_CARD_THE_MONARCHS_STORMFORTH] = 1,
    [ITEM_CARD_THE_PHANTOM_KNIGHTS_OF_ANCIENT_CLOAK] = 1,
    [ITEM_CARD_THE_PHANTOM_KNIGHTS_OF_BREAK_SWORD] = 1,
    [ITEM_CARD_THE_PHANTOM_KNIGHTS_OF_SILENT_BOOTS] = 1,
    [ITEM_CARD_THE_PRIME_MONARCH] = 1,
    [ITEM_CARD_THE_TRICKY] = 1,
    [ITEM_CARD_THE_WHITE_STONE_OF_ANCIENTS] = 1,
    [ITEM_CARD_THE_WHITE_STONE_OF_LEGEND] = 1,
    [ITEM_CARD_THE_WICKED_WORM_BEAST] = 1,
    [ITEM_CARD_THE_WINGED_DRAGON_OF_RA_SPHERE_MODE] = 1,
    [ITEM_CARD_THERE_CAN_BE_ONLY_ONE] = 1,
    [ITEM_CARD_THESTALOS_THE_FIRESTORM_MONARCH] = 1,
    [ITEM_CARD_THESTALOS_THE_MEGA_MONARCH] = 1,
    [ITEM_CARD_THESTALOS_THE_SHADOWFIRE_MONARCH] = 1,
    [ITEM_CARD_THOUGHT_RULER_ARCHFIEND] = 1,
    [ITEM_CARD_THOUSAND_EYES_RESTRICT] = 1,
    [ITEM_CARD_THREATENING_ROAR] = 1,
    [ITEM_CARD_THROWSTONE_UNIT] = 1,
    [ITEM_CARD_THUNDER_DRAGON] = 1,
    [ITEM_CARD_THUNDER_DRAGON_COLOSSUS] = 1,
    [ITEM_CARD_THUNDER_DRAGON_TITAN] = 1,
    [ITEM_CARD_THUNDER_DRAGONDARK] = 1,
    [ITEM_CARD_THUNDER_DRAGONDUO] = 1,
    [ITEM_CARD_THUNDER_DRAGONHAWK] = 1,
    [ITEM_CARD_THUNDER_DRAGONLORD] = 1,
    [ITEM_CARD_THUNDER_DRAGONMATRIX] = 1,
    [ITEM_CARD_THUNDER_DRAGONROAR] = 1,
    [ITEM_CARD_THUNDER_KING_RAI_OH] = 1,
    [ITEM_CARD_THUNDER_NYAN_NYAN] = 1,
    [ITEM_CARD_THUNDER_SEA_HORSE] = 1,
    [ITEM_CARD_TIDAL_DRAGON_RULER_OF_WATERFALLS] = 1,
    [ITEM_CARD_TIMAEUS_THE_UNITED_DRAGON] = 1,
    [ITEM_CARD_TIME_SEAL] = 1,
    [ITEM_CARD_TIME_SPACE_TRAP_HOLE] = 1,
    [ITEM_CARD_TITANIKLAD_THE_ASH_DRAGON] = 1,
    [ITEM_CARD_TLAKALEL_HIS_MALEVOLENT_MAJESTY] = 1,
    [ITEM_CARD_TOADALLY_AWESOME] = 1,
    [ITEM_CARD_TOBARI_THE_SKY_NINJA] = 1,
    [ITEM_CARD_TOKEN_COLLECTOR] = 1,
    [ITEM_CARD_TOON_CANNON_SOLDIER] = 1,
    [ITEM_CARD_TOON_CYBER_DRAGON] = 1,
    [ITEM_CARD_TOON_DARK_MAGICIAN_GIRL] = 1,
    [ITEM_CARD_TOON_GEMINI_ELF] = 1,
    [ITEM_CARD_TOON_GOBLIN_ATTACK_FORCE] = 1,
    [ITEM_CARD_TOON_MASKED_SORCERER] = 1,
    [ITEM_CARD_TOON_SUMMONED_SKULL] = 1,
    [ITEM_CARD_TOON_TABLE_OF_CONTENTS] = 1,
    [ITEM_CARD_TORNADO_DRAGON] = 1,
    [ITEM_CARD_TORRENTIAL_TRIBUTE] = 1,
    [ITEM_CARD_TOTEM_BIRD] = 1,
    [ITEM_CARD_TOUR_GUIDE_FROM_THE_UNDERWORLD] = 1,
    [ITEM_CARD_TRADETOAD] = 1,
    [ITEM_CARD_TRAGOEDIA] = 1,
    [ITEM_CARD_TRAP_DUSTSHOOT] = 1,
    [ITEM_CARD_TRAP_EATER] = 1,
    [ITEM_CARD_TRAP_HOLE] = 1,
    [ITEM_CARD_TRAP_MASTER] = 1,
    [ITEM_CARD_TRAP_STUN] = 1,
    [ITEM_CARD_TRAPTRIX_ARACHNOCAMPA] = 1,
    [ITEM_CARD_TRAPTRIX_ATRAX] = 1,
    [ITEM_CARD_TRAPTRIX_DIONAEA] = 1,
    [ITEM_CARD_TRAPTRIX_GENLISEA] = 1,
    [ITEM_CARD_TRAPTRIX_MANTIS] = 1,
    [ITEM_CARD_TRAPTRIX_MYRMELEO] = 1,
    [ITEM_CARD_TRAPTRIX_NEPENTHES] = 1,
    [ITEM_CARD_TRAPTRIX_PUDICA] = 1,
    [ITEM_CARD_TRAPTRIX_RAFFLESIA] = 1,
    [ITEM_CARD_TRAPTRIX_TRAP_HOLE_NIGHTMARE] = 1,
    [ITEM_CARD_TRAPTRIX_VESICULO] = 1,
    [ITEM_CARD_TREEBORN_FROG] = 1,
    [ITEM_CARD_TREMENDOUS_FIRE] = 1,
    [ITEM_CARD_TRI_BRIGADE_FRAKTALL] = 1,
    [ITEM_CARD_TRI_BRIGADE_KITT] = 1,
    [ITEM_CARD_TRI_BRIGADE_NERVALL] = 1,
    [ITEM_CARD_TRI_BRIGADE_REVOLT] = 1,
    [ITEM_CARD_TRIBE_INFECTING_VIRUS] = 1,
    [ITEM_CARD_TRIBUTE_TO_THE_DOOMED] = 1,
    [ITEM_CARD_TRICKSTAR_CANDINA] = 1,
    [ITEM_CARD_TRICKSTAR_LIGHT_STAGE] = 1,
    [ITEM_CARD_TRICKSTAR_LYCORIS] = 1,
    [ITEM_CARD_TRICKSTAR_REINCARNATION] = 1,
    [ITEM_CARD_TRIPLE_TACTICS_TALENT] = 1,
    [ITEM_CARD_TRIPLE_TACTICS_THRUST] = 1,
    [ITEM_CARD_TRISHULA_DRAGON_OF_THE_ICE_BARRIER] = 1,
    [ITEM_CARD_TRUE_DRACO_HERITAGE] = 1,
    [ITEM_CARD_TRUE_KING_S_RETURN] = 1,
    [ITEM_CARD_TSUKUYOMI] = 1,
    [ITEM_CARD_TWILIGHT_NINJA_GETSUGA_THE_SHOGUN] = 1,
    [ITEM_CARD_TWILIGHT_NINJA_NICHIRIN_THE_CHUNIN] = 1,
    [ITEM_CARD_TWILIGHT_NINJA_SHINGETSU] = 1,
    [ITEM_CARD_TWIN_TWISTERS] = 1,
    [ITEM_CARD_TWIN_HEADED_BEHEMOTH] = 1,
    [ITEM_CARD_TWIN_HEADED_THUNDER_DRAGON] = 1,
    [ITEM_CARD_TWISTER] = 1,
    [ITEM_CARD_TYPHOON] = 1,
    [ITEM_CARD_UFO_TURTLE] = 1,
    [ITEM_CARD_ULTIMATE_FLAME_SWORDSMAN] = 1,
    [ITEM_CARD_ULTIMATE_INSECT_LV3] = 1,
    [ITEM_CARD_ULTIMATE_INSECT_LV5] = 1,
    [ITEM_CARD_ULTIMATE_INSECT_LV7] = 1,
    [ITEM_CARD_ULTIMATE_OFFERING] = 1,
    [ITEM_CARD_ULTIMATE_SLAYER] = 1,
    [ITEM_CARD_UNITED_WE_STAND] = 1,
    [ITEM_CARD_UPSTART_GOBLIN] = 1,
    [ITEM_CARD_UPSTART_GOLDEN_NINJA] = 1,
    [ITEM_CARD_VAMPIRE_LORD] = 1,
    [ITEM_CARD_VANITY_S_EMPTINESS] = 1,
    [ITEM_CARD_VANITY_S_FIEND] = 1,
    [ITEM_CARD_VECTOR_PENDULUM_THE_DRACOVERLORD] = 1,
    [ITEM_CARD_VESSEL_FOR_THE_DRAGON_CYCLE] = 1,
    [ITEM_CARD_VIRGIL_ROCK_STAR_OF_THE_BURNING_ABYSS] = 1,
    [ITEM_CARD_VISION_HERO_VYON] = 1,
    [ITEM_CARD_VOID_FEAST] = 1,
    [ITEM_CARD_VOID_VANISHMENT] = 1,
    [ITEM_CARD_VOLCANIC_SCATTERSHOT] = 1,
    [ITEM_CARD_VORSE_RAIDER] = 1,
    [ITEM_CARD_WABOKU] = 1,
    [ITEM_CARD_WALL_OF_ILLUSION] = 1,
    [ITEM_CARD_WALL_OF_REVEALING_LIGHT] = 1,
    [ITEM_CARD_WANDERING_GRYPHON_RIDER] = 1,
    [ITEM_CARD_WANTED_SEEKER_OF_SINFUL_SPOILS] = 1,
    [ITEM_CARD_WATER_ENCHANTRESS_OF_THE_TEMPLE] = 1,
    [ITEM_CARD_WAVE_MOTION_CANNON] = 1,
    [ITEM_CARD_WAVERING_EYES] = 1,
    [ITEM_CARD_WHITE_DRAGON_NINJA] = 1,
    [ITEM_CARD_WHITE_DRAGON_RITUAL] = 1,
    [ITEM_CARD_WHITE_DRAGON_WYVERBURSTER] = 1,
    [ITEM_CARD_WHITE_MAGICAL_HAT] = 1,
    [ITEM_CARD_WHITE_NIGHT_DRAGON] = 1,
    [ITEM_CARD_WHITE_NINJA] = 1,
    [ITEM_CARD_WIDESPREAD_RUIN] = 1,
    [ITEM_CARD_WIND_UP_FACTORY] = 1,
    [ITEM_CARD_WIND_UP_MAGICIAN] = 1,
    [ITEM_CARD_WIND_UP_RABBIT] = 1,
    [ITEM_CARD_WIND_UP_RAT] = 1,
    [ITEM_CARD_WIND_UP_SHARK] = 1,
    [ITEM_CARD_WIND_UP_ZENMAINES] = 1,
    [ITEM_CARD_WITCH_OF_THE_BLACK_FOREST] = 1,
    [ITEM_CARD_WROUGHTWEILER] = 1,
    [ITEM_CARD_WULF_LIGHTSWORN_BEAST] = 1,
    [ITEM_CARD_X_HEAD_CANNON] = 1,
    [ITEM_CARD_X_SABER_AIRBELLUM] = 1,
    [ITEM_CARD_X_SABER_URBELLUM] = 1,
    [ITEM_CARD_XING_ZHEN_HU] = 1,
    [ITEM_CARD_XX_SABER_BOGGART_KNIGHT] = 1,
    [ITEM_CARD_XX_SABER_DARKSOUL] = 1,
    [ITEM_CARD_XX_SABER_EMMERSBLADE] = 1,
    [ITEM_CARD_XX_SABER_FAULTROLL] = 1,
    [ITEM_CARD_XX_SABER_FULHELMKNIGHT] = 1,
    [ITEM_CARD_XX_SABER_GOTTOMS] = 1,
    [ITEM_CARD_XX_SABER_HYUNLEI] = 1,
    [ITEM_CARD_XYZ_ENCORE] = 1,
    [ITEM_CARD_YATA_GARASU] = 1,
    [ITEM_CARD_YELLOW_DRAGON_NINJA] = 1,
    [ITEM_CARD_YELLOW_NINJA] = 1,
    [ITEM_CARD_YOMI_SHIP] = 1,
    [ITEM_CARD_ZABORG_THE_THUNDER_MONARCH] = 1,
    [ITEM_CARD_ZOMBIE_MASTER] = 1,
    [ITEM_CARD_ZOMBIE_WORLD] = 1,
    [ITEM_CARD_ZOMBINO] = 1,
    [ITEM_CARD_ZOMBYRA_THE_DARK] = 1,
    [ITEM_CARD_ZOODIAC_BARRAGE] = 1,
    [ITEM_CARD_ZOODIAC_BOARBOW] = 1,
    [ITEM_CARD_ZOODIAC_BROADBULL] = 1,
    [ITEM_CARD_ZOODIAC_CHAKANINE] = 1,
    [ITEM_CARD_ZOODIAC_COMBO] = 1,
    [ITEM_CARD_ZOODIAC_DRIDENT] = 1,
    [ITEM_CARD_ZOODIAC_HAMMERKONG] = 1,
    [ITEM_CARD_ZOODIAC_RAMRAM] = 1,
    [ITEM_CARD_ZOODIAC_RATPIER] = 1,
    [ITEM_CARD_ZOODIAC_THOROUGHBLADE] = 1,
    [ITEM_CARD_ZOODIAC_TIGERMORTAR] = 1,
    [ITEM_CARD_ZOODIAC_WHIPTAIL] = 1,
    [ITEM_CARD_ZURE_KNIGHT_OF_DARK_WORLD] = 1,
	[ITEM_LIST_END] = 0,};

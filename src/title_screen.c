...
// const rom data
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/lapras.4bpp.lz");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/lapras.bin.lz");
...
void CB2_InitTitleScreen(void)
{
    ...
    case 4:
        ...
        SetGpuReg(REG_OFFSET_BG2CNT, BGCNT_PRIORITY(1) | BGCNT_CHARBASE(0) | BGCNT_SCREENBASE(9) | BGCNT_256COLOR | BGCNT_TXT256x256);
        ...
        SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_MODE_0
                                    ...
                                    | DISPCNT_WIN0_ON
                                    | DISPCNT_OBJWIN_ON);
        m4aSongNumStart(MUS_TITLE_SCREEN_ISLAND);
        gMain.state = 5;
        break;
    case 5:

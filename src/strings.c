...
const u8 gText_SynchroPendulum[] = _("Synchro/Pendulum");
const u8 gText_Link[] = _("Link");
const u8 gText_XYZPendulum[] = _("XYZ/Pendulum");
const u8 gText_NormalTuner[] = _("Normal/Tuner");
const u8 gText_PendulumEffect[] = _("Pendulum/Effect");
const u8 gText_PendulumRitual[] = _("Pendulum/Ritual");
const u8 gText_PendulumFusion[] = _("Pendulum/Fusion");
const u8 gText_PendulumNormal[] = _("Pendulum/Normal");
const u8 gText_PendulumTuner[] = _("Pendulum/Tuner");
const u8 gText_PendulumFlip[] = _("Pendulum/Flip");
const u8 gText_FlipTuner[] = _("Flip/Tuner");

...
static u16 PullCardFromPack(u16 pack)
{
    ...
    else if (pack == PACK_YUGI_KAIBA)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceYK;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_CRITTER)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceCritter;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_TREASURE)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceTreasure;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_IMPERIAL)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceImperial;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_ANDROID)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceAndroid;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_JOEY_PEGASUS)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceJoeyPegasus;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_FIBER)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceFiber;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_YATA)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceYata;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_SCIENTIST)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceScientist;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_VAMPIRE)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceVampire;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_CHAOS)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceChaos;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_WARRIOR)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceWarrior;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_GOAT)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceGoat;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_CYBER)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceCyber;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_REAPER)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceReaper;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_CHAOS_RETURN)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceChaosReturn;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_DEMISE)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceDemise;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_TROOPER)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceTrooper;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_ZOMBIE)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceZombie;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_PERFECT_CIRCLE)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].pricePerfectCircle;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_DAD_RETURN)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceDADReturn;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_GLADIATOR)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceGladiator;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_TELEDAD)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceTeleDAD;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_CAT)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceCat;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_EDISON)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceEdison;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_FROG)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceFrog;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_STARSTRIKE)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceStarstrike;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_TENGU)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceTengu;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_DINO_RABBIT)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceDinoRabbit;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_WIND_UP)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceWindUp;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_MIAMI)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceMiami;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_MEADOWLANDS)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceMeadowlands;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_BABY_RULER)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceBabyRuler;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_RAVINE_RULER)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceRavineRuler;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_FIRE_WATER)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceFireWater;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_HAT)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceHAT;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {
    ...
    else if (pack == PACK_VEGAS)
    {
        ...
        for (k = 0; k < 5; k++)
        {
            ...
            for (i = 0; i < length; i++)
            {
                u16 rarity = 1000 - gCardInfo[items[i]].priceVegas;
                u16 card = items[i];
                l -= rarity;
                if (l <= rarity)
                {

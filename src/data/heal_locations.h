static const struct HealLocation sHealLocations[] =
{
    ...
    [SPAWN_ORANGE_ISLANDS_KINNOW_ISLAND - 1] = {MAP_GROUP(ORANGE_ISLANDS_KINNOW_ISLAND), MAP_NUM(ORANGE_ISLANDS_KINNOW_ISLAND), 16, 13},
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_ORANGE_ISLANDS_KINNOW_ISLAND - 1] = {MAP_GROUP(ORANGE_ISLANDS_KINNOW_ISLAND), MAP_NUM(ORANGE_ISLANDS_KINNOW_ISLAND)},
};
...
static const u8 sWhiteoutRespawnHealerNpcIds[] =
{
    ...
    [SPAWN_ORANGE_ISLANDS_KINNOW_ISLAND - 1] = 1,
};

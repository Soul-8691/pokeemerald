static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SOUTHERN_ISLAND_EXTERIOR - 1] = {MAP_GROUP(SOUTHERN_ISLAND_EXTERIOR), MAP_NUM(SOUTHERN_ISLAND_EXTERIOR), 12, 20},
    ...
    [SPAWN_VALENCIA_ISLAND - 1] = {MAP_GROUP(VALENCIA_ISLAND), MAP_NUM(VALENCIA_ISLAND), 27, 16},
    [SPAWN_SHAMOUTI_ISLAND - 1] = {MAP_GROUP(SHAMOUTI_ISLAND), MAP_NUM(SHAMOUTI_ISLAND), 20, 19},
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_VALENCIA_ISLAND - 1] = {MAP_GROUP(VALENCIA_ISLAND), MAP_NUM(VALENCIA_ISLAND)},
    [SPAWN_SHAMOUTI_ISLAND - 1] = {MAP_GROUP(SHAMOUTI_ISLAND), MAP_NUM(SHAMOUTI_ISLAND)},
};
...
static const u8 sWhiteoutRespawnHealerNpcIds[] =
{
    ...
    [SPAWN_VALENCIA_ISLAND - 1] = 1,
    [SPAWN_SHAMOUTI_ISLAND - 1] = 1,
};

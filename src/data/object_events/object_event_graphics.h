...
const u32 gObjectEventPic_FRLGCubone[] = INCBIN_U32("graphics/object_events/pics/pokemon/rhydon.4bpp");
...
const u16 gObjectEventPal_Rhydon[] = INCBIN_U16("graphics/object_events/pics/pokemon/rhydon.gbapal");

...
static const u32 sNewGameBirch_Gfx[] = INCBIN_U32("graphics/birch_speech/drake.4bpp");
static const u16 sNewGameBirch_Pal[16] = INCBIN_U16("graphics/birch_speech/drake.gbapal");
...
{
    s32 spriteId = CreateMonPicSprite(species, 0, 0x8000, FALSE, x, y, 0, gMonPaletteTable[species].tag);
...
{
    const struct SpritePalette *spritePalette = GetMonSpritePalStructFromOtIdPersonality(species, otId, personality);
    u16 spriteId = CreateMonPicSprite(species, otId, personality, FALSE, x, y, 0, spritePalette->tag);

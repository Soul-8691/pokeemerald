...
#define VAR_TEAM_ROCKET                                  0x402C // Unused Var, used to be VAR_RESET_RTC_ENABLE
...
#define VAR_PROFESSOR_IVY                                0x4052 // Unused Var
#define VAR_LAVARIDGE_TOWN_STATE                         0x4053
#define VAR_CURRENT_SECRET_BASE                          0x4054 // was probably allocated for VAR_FALLARBOR_TOWN_STATE at one point
#define VAR_DARKNESS                                     0x4055 // Unused Var
